var sr = { exports: {} };
(function() {
  var L, fe, Fe, $e, Je, $, hi, mt = { d: function(s, e) {
    for (var t in e) mt.o(e, t) && !mt.o(s, t) && Object.defineProperty(s, t, { enumerable: !0, get: e[t] });
  }, o: function(s, e) {
    return Object.prototype.hasOwnProperty.call(s, e);
  }, r: function(s) {
    typeof Symbol < "u" && Symbol.toStringTag && Object.defineProperty(s, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(s, "__esModule", { value: !0 });
  } }, kt = {};
  mt.r(kt), mt.d(kt, { hideMessageBox: function() {
    return ga;
  ...
  class Ze {
    ...
    constructor(e) {
      this._id = typeof e != "string" ? e : new Q(e);
    }
    isEqual(e) {
      return typeof e == "string" ? this._id.isEqual(e) : e instanceof Q ? this._id.isEqual(e.s) : e instanceof Ze && this._id.isEqual(e._id.s);
    }
    isNotEqual(e) {
      return typeof e == "string" ? !this._id.isEqual(e) : e instanceof Q ? !this._id.isEqual(e.s) : e instanceof Ze && !this._id.isEqual(e._id.s);
    }
  ...
  class gi {
    ...
    registerId(e) {
      let t = null;
      return typeof e != "string" ? this.registerId(e.s) : ((t = this.findId(e)) != null || (t = new Ze(e), this._ids.pushBack(t)), t);
    }
    getId(e) {
  ...
  class N {
    ...
    multiplyByMatrix(e) {
      N.multiply(e.getArray(), this._tr, this._tr);
    }
    clone() {
      const e = new N();
  ...
  class pt {
    ...
    constructor() {
      this._isCulling = !1, this._isPremultipliedAlpha = !1, this._anisotropy = 0, this._model = null, this._modelColor = new q(), this._useHighPrecisionMask = !1, this._mvpMatrix4x4 = new N(), this._mvpMatrix4x4.loadIdentity();
    }
  }
  (function(s) {
  ...
  (function(s) {
    s.CubismBlendMode = $, s.CubismRenderer = pt, s.CubismTextureColor = q;
  })(hi || (hi = {}));
  const ft = (s, e, t) => {
    ((i, r, a) => {
      di.print(i, "[CSM]" + r, a);
...
`, t);
  ...
  let Ke, ne, ye, G;
  Ke = (s, ...e) => {
    ft(Se.LogLevel_Debug, "[D]" + s, e);
  }, ne = (s, ...e) => {
    ft(Se.LogLevel_Info, "[I]" + s, e);
  }, ye = (s, ...e) => {
    ft(Se.LogLevel_Warning, "[W]" + s, e);
  }, G = (s, ...e) => {
    ft(Se.LogLevel_Error, "[E]" + s, e);
  };
  class di {
    static print(e, t, i) {
...
`);
  ...
  class Y {
    ...
    prepareCapacity(e, t) {
      e > this._keyValues.length && (this._keyValues.length == 0 ? (!t && e < Y.DefaultSize && (e = Y.DefaultSize), this._keyValues.length = e) : (!t && e < 2 * this._keyValues.length && (e = 2 * this._keyValues.length), this._keyValues.length = e));
    }
    begin() {
      return new Me(this, 0);
    }
    end() {
      return new Me(this, this._size);
    }
    erase(e) {
      const t = e._index;
      return t < 0 || this._size <= t ? e : (this._keyValues.splice(t, 1), --this._size, new Me(this, t));
    }
    dumpAsInt() {
      for (let e = 0; e < this._size; e++) Ke("{0} ,", this._keyValues[e]), Ke(`
`);
    }
  }
  Y.DefaultSize = 10;
  class Me {
    constructor(e, t) {
      this._map = e ?? new Y(), this._index = t ?? 0;
    }
    set(e) {
    ...
    increment() {
      return new Me(this._map, this._index++);
    }
    decrement() {
      const e = new Me(this._map, this._index);
  ...
  (function(s) {
    s.csmMap = Y, s.csmPair = mi, s.iterator = Me;
  })(_i || (_i = {}));
  class yt {
    static parseJsonObject(e, t) {
      return Object.keys(e).forEach((i) => {
        if (typeof e[i] == "boolean") {
          ...
          const r = Number(e[i]);
          t.put(i, new St(r));
        } else e[i] instanceof Array ? t.put(i, yt.parseJsonArray(e[i])) : e[i] instanceof Object ? t.put(i, yt.parseJsonObject(e[i], new De())) : e[i] == null ? t.put(i, new Ae()) : t.put(i, e[i]);
      }), t;
    }
    static parseJsonArray(e) {
      ...
      return Object.keys(e).forEach((i) => {
        if (typeof Number(i) == "number") if (typeof e[i] == "boolean") {
          ...
          const r = Number(e[i]);
          t.add(new St(r));
        } else e[i] instanceof Array ? t.add(this.parseJsonArray(e[i])) : e[i] instanceof Object ? t.add(this.parseJsonObject(e[i], new De())) : e[i] == null ? t.add(new Ae()) : t.add(e[i]);
        else if (e[i] instanceof Array) t.add(this.parseJsonArray(e[i]));
        else if (e[i] instanceof Object) t.add(this.parseJsonObject(e[i], new De()));
        else if (e[i] == null) t.add(new Ae());
        else {
          const r = Array(e[i]);
  ...
  class A {
    ...
    getValueByIndex(e) {
      return A.errorValue.setErrorNotForClientCall(xt);
    }
    getValueByString(e) {
      return A.nullValue.setErrorNotForClientCall(xt);
    }
    getKeys() {
    ...
    setErrorNotForClientCall(e) {
      return Qe.errorValue;
    }
    static staticInitializeNotForClientCall() {
      oe.trueValue = new oe(!0), oe.falseValue = new oe(!1), A.errorValue = new Qe("ERROR", !0), A.nullValue = new Ae(), A.s_dummyKeys = new S();
    }
    static staticReleaseNotForClientCall() {
      oe.trueValue = null, oe.falseValue = null, A.errorValue = null, A.nullValue = null, A.s_dummyKeys = null;
    }
  }
  class z {
    constructor(e, t) {
      this._parseCallback = yt.parseJsonObject, this._error = null, this._lineCount = 0, this._root = null, e != null && this.parseBytes(e, t, this._parseCallback);
    }
    static create(e, t) {
      const i = new z();
      return i.parseBytes(e, t, i._parseCallback) ? i : (z.delete(i), null);
    }
    static delete(e) {
    }
    getRoot() {
    ...
    parseBytes(e, t, i) {
      const r = new Array(1), a = z.arrayBufferToString(e);
      if (this._root = i == null ? this.parseValue(a, t, 0, r) : i(JSON.parse(a), new De()), this._error) {
        let o = "\0";
        return o = "Json parse error : @line " + (this._lineCount + 1) + `
`, this._root = new Le(o), ne("{0}", this._root.getRawString()), !1;
      }
      return this._root != null || (this._root = new Qe(new Q(this._error), !1), !1);
    }
    getParseError() {
      return this._error;
    }
    ...
    parseValue(e, t, i, r) {
      ...
      for (; n < t; n++) switch (e[n]) {
        ...
        case "9": {
          const l = new Array(1);
          return a = nr(e.slice(n), l), r[0] = e.indexOf(l[0]), new St(a);
        }
        case '"':
          return new Le(this.parseString(e, t, n + 1, r));
        case "[":
          return o = this.parseArray(e, t, n + 1, r), o;
        case "{":
          return o = this.parseObject(e, t, n + 1, r), o;
        case "n":
          return n + 3 < t ? (o = new Ae(), r[0] = n + 4) : this._error = "parse null", o;
        case "t":
          return n + 3 < t ? (o = oe.trueValue, r[0] = n + 4) : this._error = "parse true", o;
        case "f":
          return n + 4 < t ? (o = oe.falseValue, r[0] = n + 5) : this._error = "illegal ',' position", o;
        case ",":
...
`:
  ...
  class Le extends A {
    constructor(e) {
      super(), typeof e == "string" && (this._stringBuffer = e), e instanceof Q && (this._stringBuffer = e.s);
    }
    isString() {
      return !0;
    }
    ...
    equals(e) {
      return typeof e == "string" ? this._stringBuffer == e : e instanceof Q && this._stringBuffer == e.s;
    }
  }
  class Qe extends Le {
    isStatic() {
  ...
  class Ae extends A {
    ...
    setErrorNotForClientCall(e) {
      return this._stringBuffer = e, Qe.nullValue;
    }
    constructor() {
...
`, this._stringBuffer;
  ...
  (function(s) {
    s.CubismJson = z, s.JsonArray = Ot, s.JsonBoolean = oe, s.JsonError = Qe, s.JsonFloat = St, s.JsonMap = De, s.JsonNullvalue = Ae, s.JsonString = Le, s.Value = A;
  })(pi || (pi = {}));
  let le = !1, ke = !1, Oe = null, et = null;
  const xe = Object.freeze({ vertexOffset: 0, vertexStep: 2 });
  function or(s) {
  }
  class V {
    static startUp(e = null) {
      if (le) return ne("CubismFramework.startUp() is already done."), le;
      if (Oe = e, Oe != null && Live2DCubismCore.Logging.csmSetLogFunction(Oe.logFunction), le = !0, le) {
        const t = Live2DCubismCore.Version.csmGetVersion(), i = (16711680 & t) >> 16, r = 65535 & t, a = t;
        ne("Live2D Cubism Core version: {0}.{1}.{2} ({3})", ("00" + ((4278190080 & t) >> 24)).slice(-2), ("00" + i).slice(-2), ("0000" + r).slice(-4), a);
      }
      return ne("CubismFramework.startUp() is complete."), le;
    }
    static cleanUp() {
      le = !1, ke = !1, Oe = null, et = null;
    }
    static initialize(e = 0) {
      ae(le), le ? ke ? ye("CubismFramework.initialize() skipped, already initialized.") : (A.staticInitializeNotForClientCall(), et = new gi(), Live2DCubismCore.Memory.initializeAmountOfMemory(e), ke = !0, ne("CubismFramework.initialize() is complete.")) : ye("CubismFramework is not started.");
    }
    static dispose() {
      ae(le), le ? ke ? (A.staticReleaseNotForClientCall(), et.release(), et = null, pt.staticRelease(), ke = !1, ne("CubismFramework.dispose() is complete.")) : ye("CubismFramework.dispose() skipped, not initialized.") : ye("CubismFramework is not started.");
    }
    static isStarted() {
      return le;
    }
    ...
    static getLoggingLevel() {
      return Oe != null ? Oe.loggingLevel : Se.LogLevel_Off;
    }
    static getIdManager() {
      return et;
    }
  ...
  (function(s) {
    ...
    s.Constant = xe, s.csmDelete = or, s.CubismFramework = V;
  }(fi || (fi = {}));
  var b = { Canvas: void 0, CanvasId: "live2d", MessageBoxId: "live2dMessageBox", BackgroundRGBA: [0, 0, 0, 0], CanvasSize: "auto", LoadFromCache: !1, Live2dDB: void 0, ViewScale: 1, ViewMaxScale: 2, ViewMinScale: 0.8, ViewLogicalLeft: -1, ViewLogicalRight: 1, ViewLogicalMaxLeft: -2, ViewLogicalMaxRight: 2, ViewLogicalMaxBottom: -2, ViewLogicalMaxTop: 2, ResourcesPath: "", MotionGroupIdle: "Idle", MotionGroupTapBody: "TapBody", HitAreaNameHead: "Head", HitAreaNameBody: "Body", PriorityIdle: 1, PriorityNormal: 2, PriorityForce: 3, CubismLoggingLevel: Se.LogLevel_Verbose }, X = typeof globalThis < "u" && globalThis || typeof self < "u" && self || X !== void 0 && X, yi = "URLSearchParams" in X, xi = "Symbol" in X && "iterator" in Symbol, Ct = "FileReader" in X && "Blob" in X && function() {
    try {
      return new Blob(), !0;
    } catch {
      return !1;
    }
  }(), Si = "FormData" in X, Bt = "ArrayBuffer" in X;
  if (Bt) var ur = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"], hr = ArrayBuffer.isView || function(s) {
    return s && ur.indexOf(Object.prototype.toString.call(s)) > -1;
  };
  function tt(s) {
  ...
  function U(s) {
    this.map = {}, s instanceof U ? s.forEach(function(e, t) {
      this.append(t, e);
  ...
  function vi() {
    return this.bodyUsed = !1, this._initBody = function(s) {
      var e;
      this.bodyUsed = this.bodyUsed, this._bodyInit = s, s ? typeof s == "string" ? this._bodyText = s : Ct && Blob.prototype.isPrototypeOf(s) ? this._bodyBlob = s : Si && FormData.prototype.isPrototypeOf(s) ? this._bodyFormData = s : yi && URLSearchParams.prototype.isPrototypeOf(s) ? this._bodyText = s.toString() : Bt && Ct && (e = s) && DataView.prototype.isPrototypeOf(e) ? (this._bodyArrayBuffer = Bi(s.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer])) : Bt && (ArrayBuffer.prototype.isPrototypeOf(s) || hr(s)) ? this._bodyArrayBuffer = Bi(s) : this._bodyText = s = Object.prototype.toString.call(s) : this._bodyText = "", this.headers.get("content-type") || (typeof s == "string" ? this.headers.set("content-type", "text/plain;charset=UTF-8") : this._bodyBlob && this._bodyBlob.type ? this.headers.set("content-type", this._bodyBlob.type) : yi && URLSearchParams.prototype.isPrototypeOf(s) && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"));
    }, Ct && (this.blob = function() {
      var s = zt(this);
      if (s) return s;
      ...
      return this._bodyArrayBuffer ? zt(this) || (ArrayBuffer.isView(this._bodyArrayBuffer) ? Promise.resolve(this._bodyArrayBuffer.buffer.slice(this._bodyArrayBuffer.byteOffset, this._bodyArrayBuffer.byteOffset + this._bodyArrayBuffer.byteLength)) : Promise.resolve(this._bodyArrayBuffer)) : this.blob().then(gr);
    }), this.text = function() {
      var s, e, t, i = zt(this);
      if (i) return i;
      if (this._bodyBlob) return s = this._bodyBlob, t = Ci(e = new FileReader()), e.readAsText(s), t;
  ...
  U.prototype.append = function(s, e) {
    s = tt(s), e = Nt(e);
    var t = this.map[s];
    this.map[s] = t ? t + ", " + e : e;
  }, U.prototype.delete = function(s) {
    delete this.map[tt(s)];
  }, U.prototype.get = function(s) {
    return s = tt(s), this.has(s) ? this.map[s] : null;
  }, U.prototype.has = function(s) {
    return this.map.hasOwnProperty(tt(s));
  }, U.prototype.set = function(s, e) {
    this.map[tt(s)] = Nt(e);
  }, U.prototype.forEach = function(s, e) {
  ...
  }, xi && (U.prototype[Symbol.iterator] = U.prototype.entries);
  var dr = ["DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT"];
  function Pe(s, e) {
    ...
    if (s instanceof Pe) {
      ...
      this.url = s.url, this.credentials = s.credentials, e.headers || (this.headers = new U(s.headers)), this.method = s.method, this.mode = s.mode, this.signal = s.signal, r || s._bodyInit == null || (r = s._bodyInit, s.bodyUsed = !0);
    } else this.url = String(s);
    if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new U(e.headers)), this.method = (i = (t = e.method || this.method || "GET").toUpperCase(), dr.indexOf(i) > -1 ? i : t), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && r) throw new TypeError("Body not allowed for GET or HEAD requests");
  ...
  function ue(s, e) {
    if (!(this instanceof ue)) throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');
    e || (e = {}), this.type = "default", this.status = e.status === void 0 ? 200 : e.status, this.ok = this.status >= 200 && this.status < 300, this.statusText = e.statusText === void 0 ? "" : "" + e.statusText, this.headers = new U(e.headers), this.url = e.url || "", this._initBody(s);
  }
  Pe.prototype.clone = function() {
    return new Pe(this, { body: this._bodyInit });
  }, vi.call(Pe.prototype), vi.call(ue.prototype), ue.prototype.clone = function() {
    return new ue(this._bodyInit, { status: this.status, statusText: this.statusText, headers: new U(this.headers), url: this.url });
  }, ue.error = function() {
    var s = new ue(null, { status: 0, statusText: "" });
    return s.type = "error", s;
  };
  var _r = [301, 302, 303, 307, 308];
  ue.redirect = function(s, e) {
    if (_r.indexOf(e) === -1) throw new RangeError("Invalid status code");
    return new ue(null, { status: e, headers: { location: s } });
  };
  var Ne = X.DOMException;
  try {
    new Ne();
  } catch {
    (Ne = function(e, t) {
  ...
  function bi(s, e) {
    return new Promise(function(t, i) {
      var r = new Pe(s, e);
      if (r.signal && r.signal.aborted) return i(new Ne("Aborted", "AbortError"));
      var a = new XMLHttpRequest();
      function o() {
        a.abort();
      }
      a.onload = function() {
        var n, l, h = { status: a.status, statusText: a.statusText, headers: (n = a.getAllResponseHeaders() || "", l = new U(), n.replace(/\r?\n[\t ]+/g, " ").split("\r").map(function(_) {
          return _.indexOf(`
`) === 0 ? _.substr(1, _.length) : _;
        ...
        setTimeout(function() {
          i(new Ne("Aborted", "AbortError"));
        }, 0);
      }, a.open(r.method, function(n) {
        try {
          return n === "" && X.location.href ? X.location.href : n;
        } catch {
          return n;
        }
      }(r.url), !0), r.credentials === "include" ? a.withCredentials = !0 : r.credentials === "omit" && (a.withCredentials = !1), "responseType" in a && (Ct ? a.responseType = "blob" : Bt && r.headers.get("Content-Type") && r.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (a.responseType = "arraybuffer")), !e || typeof e.headers != "object" || e.headers instanceof U ? r.headers.forEach(function(n, l) {
        a.setRequestHeader(l, n);
      }) : Object.getOwnPropertyNames(e.headers).forEach(function(n) {
        a.setRequestHeader(n, Nt(e.headers[n]));
  ...
  bi.polyfill = !0, X.fetch || (X.fetch = bi, X.Headers = U, X.Request = Pe, X.Response = ue);
  ...
  const Ce = "FileReferences", Ii = "UserData", Be = "Name", Ti = "File", vt = "Ids", Vi = "Sound", Ei = "FadeInTime", Ri = "FadeOutTime", jt = "LipSync", Xt = "EyeBlink";
  var w, Fi, Li, W, Ai;
  (function(s) {
  ...
  class Di extends wi {
    constructor(e, t) {
      super(), this._json = z.create(e, t), this._json && (this._jsonValue = new S(), this._jsonValue.pushBack(this._json.getRoot().getValueByString("Groups")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Moc")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Motions")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Expressions")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Textures")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Physics")), this._jsonValue.pushBack(this._json.getRoot().getValueByString(Ce).getValueByString("Pose")), this._jsonValue.pushBack(this._json.getRoot().getValueByString("HitAreas")));
    }
    release() {
      z.delete(this._json), this._jsonValue = null;
    }
    GetJson() {
      return this._json;
    }
    ...
    getTextureDirectory() {
      const e = this._jsonValue.at(w.FrequestNode_Textures).getValueByIndex(0).getRawString().split("/"), t = e.length - 1;
      let i = "";
    ...
    getHitAreaName(e) {
      return this._jsonValue.at(w.FrequestNode_HitAreas).getValueByIndex(e).getValueByString(Be).getRawString();
    }
    getPhysicsFileName() {
    ...
    getExpressionName(e) {
      return this._jsonValue.at(w.FrequestNode_Expressions).getValueByIndex(e).getValueByString(Be).getRawString();
    }
    ...
    getUserDataFile() {
      return this.isExistUserDataFile() ? this._json.getRoot().getValueByString(Ce).getValueByString(Ii).getRawString() : "";
    }
    getLayoutMap(e) {
    ...
    getEyeBlinkParameterCount() {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        ...
        if (!i.isNull() && !i.isError() && i.getValueByString(Be).getRawString() == Xt) {
          e = i.getValueByString(vt).getVector().getSize();
          break;
        }
      }
      return e;
    ...
    getEyeBlinkParameterId(e) {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        const i = this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(t);
        if (!i.isNull() && !i.isError() && i.getValueByString(Be).getRawString() == Xt) return V.getIdManager().getId(i.getValueByString(vt).getValueByIndex(e).getRawString());
      }
      return null;
    }
    getLipSyncParameterCount() {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        const i = this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(t);
        if (!i.isNull() && !i.isError() && i.getValueByString(Be).getRawString() == jt) {
          e = i.getValueByString(vt).getVector().getSize();
          break;
        }
      }
    ...
    getLipSyncParameterId(e) {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        const i = this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(t);
        if (!i.isNull() && !i.isError() && i.getValueByString(Be).getRawString() == jt) return V.getIdManager().getId(i.getValueByString(vt).getValueByIndex(e).getRawString());
      }
      return null;
    }
    isExistModelFile() {
    ...
    isExistUserDataFile() {
      const e = this._json.getRoot().getValueByString(Ce).getValueByString(Ii);
      return !e.isNull() && !e.isError();
    }
    isExistEyeBlinkParameters() {
      if (this._jsonValue.at(w.FrequestNode_Groups).isNull() || this._jsonValue.at(w.FrequestNode_Groups).isError()) return !1;
      for (let e = 0; e < this._jsonValue.at(w.FrequestNode_Groups).getSize(); ++e) if (this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(e).getValueByString(Be).getRawString() == Xt) return !0;
      return !1;
    }
    isExistLipSyncParameters() {
      if (this._jsonValue.at(w.FrequestNode_Groups).isNull() || this._jsonValue.at(w.FrequestNode_Groups).isError()) return !1;
      for (let e = 0; e < this._jsonValue.at(w.FrequestNode_Groups).getSize(); ++e) if (this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(e).getValueByString(Be).getRawString() == jt) return !0;
      return !1;
    }
  }
  (function(s) {
  ...
  (function(s) {
    s.BreathParameterData = Ue, s.CubismBreath = it;
  })(Li || (Li = {}));
  class we {
    ...
    updateParameters(e, t) {
      ...
      switch (this._blinkingState) {
        case W.EyeState_Closing:
          r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closingSeconds, r >= 1 && (r = 1, this._blinkingState = W.EyeState_Closed, this._stateStartTimeSeconds = this._userTimeSeconds), i = 1 - r;
          break;
        case W.EyeState_Closed:
          r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._closedSeconds, r >= 1 && (this._blinkingState = W.EyeState_Opening, this._stateStartTimeSeconds = this._userTimeSeconds), i = 0;
          break;
        case W.EyeState_Opening:
          r = (this._userTimeSeconds - this._stateStartTimeSeconds) / this._openingSeconds, r >= 1 && (r = 1, this._blinkingState = W.EyeState_Interval, this._nextBlinkingTime = this.determinNextBlinkingTiming()), i = r;
          break;
        case W.EyeState_Interval:
          this._nextBlinkingTime < this._userTimeSeconds && (this._blinkingState = W.EyeState_Closing, this._stateStartTimeSeconds = this._userTimeSeconds), i = 1;
          break;
        case W.EyeState_First:
        default:
          this._blinkingState = W.EyeState_Interval, this._nextBlinkingTime = this.determinNextBlinkingTiming(), i = 1;
      }
      we.CloseIfZero || (i = -i);
      for (let a = 0; a < this._parameterIds.getSize(); ++a) e.setParameterValueById(this._parameterIds.at(a), i);
    }
    constructor(e) {
      if (this._blinkingState = W.EyeState_First, this._nextBlinkingTime = 0, this._stateStartTimeSeconds = 0, this._blinkingIntervalSeconds = 4, this._closingSeconds = 0.1, this._closedSeconds = 0.05, this._openingSeconds = 0.15, this._userTimeSeconds = 0, this._parameterIds = new S(), e != null) for (let t = 0; t < e.getEyeBlinkParameterCount(); ++t) this._parameterIds.pushBack(e.getEyeBlinkParameterId(t));
    }
  ...
  we.CloseIfZero = !0, function(s) {
    ...
    s.CubismEyeBlink = we, s.EyeState = W;
  }(Ai || (Ai = {}));
  const ki = "FadeInTime", Oi = "Link";
  class st {
    static create(e, t) {
      const i = new st(), r = z.create(e, t), a = r.getRoot();
      ...
      for (let l = 0; l < n; ++l) {
        ...
        let _ = 0;
        for (let g = 0; g < u; ++g) {
          const d = h.getValueByIndex(g), c = new rt(), m = V.getIdManager().getId(d.getValueByString("Id").getRawString());
          if (c.partId = m, !d.getValueByString(Oi).isNull()) {
            const p = d.getValueByString(Oi), v = p.getSize();
            for (let x = 0; x < v; ++x) {
              const M = new rt(), f = V.getIdManager().getId(p.getValueByIndex(x).getString());
  ...
  var Ni, Ui, zi, ji, Xi, Gi;
  (function(s) {
    s.CubismPose = st, s.PartData = rt;
  })(Ni || (Ni = {}));
  class Yi extends N {
    constructor(e, t) {
  ...
  class P {
    ...
    static cardanoAlgorithmForBezier(e, t, i, r) {
      ...
      if (_ < 0) {
        const m = -n / 3, p = m * m * m, v = this.sqrt(p), x = -h / (2 * v), M = this.range(x, -1, 1), f = Math.acos(M), D = 2 * this.cbrt(v), T = D * this.cos(f / 3) - a / 3;
        if (this.abs(T - 0.5) < g) return this.range(T, 0, 1);
        const E = D * this.cos((f + 2 * Math.PI) / 3) - a / 3;
  ...
  class Hi {
    ...
    update(e) {
      ...
      if (P.abs(a) <= 0.01 && P.abs(o) <= 0.01) return;
      const n = P.sqrt(a * a + o * o), l = t * o / n;
      let h = t * a / n - this._faceVX, u = l - this._faceVY;
      const _ = P.sqrt(h * h + u * u);
      (_ < -r || _ > r) && (h *= r / _, u *= r / _), this._faceVX += h, this._faceVY += u;
      {
        const g = 0.5 * (P.sqrt(r * r + 16 * r * n - 8 * r * n) - r), d = P.sqrt(this._faceVX * this._faceVX + this._faceVY * this._faceVY);
  ...
  class ze {
    ...
    updateParameters(e, t, i) {
      ...
      let r = this._weight;
      r = r * (this._fadeInSeconds == 0 ? 1 : P.getEasingSine((i - t.getFadeInStartTime()) / this._fadeInSeconds)) * (this._fadeOutSeconds == 0 || t.getEndTime() < 0 ? 1 : P.getEasingSine((t.getEndTime() - i) / this._fadeOutSeconds)), t.setState(i, r), ae(0 <= r && r <= 1), this.doUpdateParameters(e, i, r, t), t.getEndTime() > 0 && t.getEndTime() < i && t.setIsFinished(!0);
    }
    setFadeInTime(e) {
  ...
  class Mt extends ze {
    ...
    parse(e, t) {
      ...
      for (let o = 0; o < a; ++o) {
        const n = r.getValueByString(qi).getValueByIndex(o), l = V.getIdManager().getId(n.getValueByString("Id").getRawString()), h = n.getValueByString("Value").toFloat();
        let u;
        u = n.getValueByString(bt).isNull() || n.getValueByString(bt).getString() == "Add" ? he.ExpressionBlendType_Add : n.getValueByString(bt).getString() == "Multiply" ? he.ExpressionBlendType_Multiply : n.getValueByString(bt).getString() == "Overwrite" ? he.ExpressionBlendType_Overwrite : he.ExpressionBlendType_Add;
        const _ = new Ji();
  ...
  (function(s) {
    s.CubismExpressionMotion = Mt, s.ExpressionBlendType = he, s.ExpressionParameter = Ji;
  })(Wi || (Wi = {})), function(s) {
  ...
  class Ki {
    constructor() {
      this.type = J.CubismMotionCurveTarget_Model, this.segmentCount = 0, this.baseSegmentIndex = 0, this.fadeInTime = 0, this.fadeOutTime = 0;
    }
  }
  class Qi {
    constructor() {
  ...
  (function(s) {
    s.CubismMotionCurve = Ki, s.CubismMotionCurveTarget = J, s.CubismMotionData = es, s.CubismMotionEvent = Qi, s.CubismMotionPoint = Gt, s.CubismMotionSegment = Zi, s.CubismMotionSegmentType = ee;
  })($i || ($i = {}));
  const Z = "Meta", ve = "Curves", Pt = "FadeInTime", wt = "FadeOutTime", ts = "Segments", is = "UserData";
  class ss {
    constructor(e, t) {
      this._json = z.create(e, t);
    }
    release() {
      z.delete(this._json);
    }
    getMotionDuration() {
      return this._json.getRoot().getValueByString(Z).getValueByString("Duration").toFloat();
    }
    isMotionLoop() {
      return this._json.getRoot().getValueByString(Z).getValueByString("Loop").toBoolean();
    }
    getEvaluationOptionFlag(e) {
      return It.EvaluationOptionFlag_AreBeziersRistricted == e && this._json.getRoot().getValueByString(Z).getValueByString("AreBeziersRestricted").toBoolean();
    }
    getMotionCurveCount() {
      return this._json.getRoot().getValueByString(Z).getValueByString("CurveCount").toInt();
    }
    getMotionFps() {
      return this._json.getRoot().getValueByString(Z).getValueByString("Fps").toFloat();
    }
    getMotionTotalSegmentCount() {
      return this._json.getRoot().getValueByString(Z).getValueByString("TotalSegmentCount").toInt();
    }
    getMotionTotalPointCount() {
      return this._json.getRoot().getValueByString(Z).getValueByString("TotalPointCount").toInt();
    }
    isExistMotionFadeInTime() {
      return !this._json.getRoot().getValueByString(Z).getValueByString(Pt).isNull();
    }
    isExistMotionFadeOutTime() {
      return !this._json.getRoot().getValueByString(Z).getValueByString(wt).isNull();
    }
    getMotionFadeInTime() {
      return this._json.getRoot().getValueByString(Z).getValueByString(Pt).toFloat();
    }
    getMotionFadeOutTime() {
      return this._json.getRoot().getValueByString(Z).getValueByString(wt).toFloat();
    }
    getMotionCurveTarget(e) {
      return this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString("Target").getRawString();
    }
    getMotionCurveId(e) {
      return V.getIdManager().getId(this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString("Id").getRawString());
    }
    isExistMotionCurveFadeInTime(e) {
      return !this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(Pt).isNull();
    }
    isExistMotionCurveFadeOutTime(e) {
      return !this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(wt).isNull();
    }
    getMotionCurveFadeInTime(e) {
      return this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(Pt).toFloat();
    }
    getMotionCurveFadeOutTime(e) {
      return this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(wt).toFloat();
    }
    getMotionCurveSegmentCount(e) {
      return this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(ts).getVector().getSize();
    }
    getMotionCurveSegment(e, t) {
      return this._json.getRoot().getValueByString(ve).getValueByIndex(e).getValueByString(ts).getValueByIndex(t).toFloat();
    }
    getEventCount() {
      return this._json.getRoot().getValueByString(Z).getValueByString("UserDataCount").toInt();
    }
    getTotalEventValueSize() {
      return this._json.getRoot().getValueByString(Z).getValueByString("TotalUserDataSize").toInt();
    }
    getEventTime(e) {
      return this._json.getRoot().getValueByString(is).getValueByIndex(e).getValueByString("Time").toFloat();
    }
    getEventValue(e) {
      return new Q(this._json.getRoot().getValueByString(is).getValueByIndex(e).getValueByString("Value").getRawString());
    }
  }
  var It, rs;
  (function(s) {
  ...
  function pr(s, e) {
    ...
    t < 0 && (t = 0);
    const i = te(s[0], s[1], t), r = te(s[1], s[2], t), a = te(s[2], s[3], t), o = te(i, r, t), n = te(r, a, t);
    return te(o, n, t).value;
  }
  function fr(s, e) {
    const t = e, i = s[0].time, r = s[3].time, a = s[1].time, o = s[2].time, n = r - 3 * o + 3 * a - i, l = 3 * o - 6 * a + 3 * i, h = 3 * a - 3 * i, u = i - t, _ = P.cardanoAlgorithmForBezier(n, l, h, u), g = te(s[0], s[1], _), d = te(s[1], s[2], _), c = te(s[2], s[3], _), m = te(g, d, _), p = te(d, c, _);
    return te(m, p, _).value;
  }
  function yr(s, e) {
    return s[0].value;
  }
  ...
  function Yt(s, e, t) {
    ...
    let o = 0;
    for (let l = i.baseSegmentIndex; l < a; ++l) if (o = s.segments.at(l).basePointIndex + (s.segments.at(l).segmentType == ee.CubismMotionSegmentType_Bezier ? 3 : 1), s.points.at(o).time > t) {
      r = l;
      break;
    }
  ...
  class Vt extends ze {
    ...
    doUpdateParameters(e, t, i, r) {
      this._modelCurveIdEyeBlink == null && (this._modelCurveIdEyeBlink = V.getIdManager().getId("EyeBlink")), this._modelCurveIdLipSync == null && (this._modelCurveIdLipSync = V.getIdManager().getId("LipSync")), this._modelCurveIdOpacity == null && (this._modelCurveIdOpacity = V.getIdManager().getId(Tt));
      let a = t - r.getStartTime();
      a < 0 && (a = 0);
      let o = Number.MAX_VALUE, n = Number.MAX_VALUE;
      const l = 64;
      let h = 0, u = 0;
      this._eyeBlinkParameterIds.getSize() > l && Ke("too many eye blink targets : {0}", this._eyeBlinkParameterIds.getSize()), this._lipSyncParameterIds.getSize() > l && Ke("too many lip sync targets : {0}", this._lipSyncParameterIds.getSize());
      ...
      for (c = 0; c < this._motionData.curveCount && v.at(c).type == J.CubismMotionCurveTarget_Model; ++c) d = Yt(this._motionData, c, p), v.at(c).id == this._modelCurveIdEyeBlink ? n = d : v.at(c).id == this._modelCurveIdLipSync ? o = d : v.at(c).id == this._modelCurveIdOpacity && (this._modelOpacity = d, e.setModelOapcity(this.getModelOpacityValue()));
      for (; c < this._motionData.curveCount && v.at(c).type == J.CubismMotionCurveTarget_Parameter; ++c) {
        if (m = e.getParameterIndex(v.at(c).id), m == -1) continue;
        const x = e.getParameterValueByIndex(m);
        if (d = Yt(this._motionData, c, p), n != Number.MAX_VALUE) {
        ...
        if (v.at(c).fadeInTime < 0 && v.at(c).fadeOutTime < 0) M = x + (d - x) * i;
          ...
          let f, D;
          f = v.at(c).fadeInTime < 0 ? _ : v.at(c).fadeInTime == 0 ? 1 : P.getEasingSine((t - r.getFadeInStartTime()) / v.at(c).fadeInTime), D = v.at(c).fadeOutTime < 0 ? g : v.at(c).fadeOutTime == 0 || r.getEndTime() < 0 ? 1 : P.getEasingSine((r.getEndTime() - t) / v.at(c).fadeOutTime), M = x + (d - x) * (this._weight * f * D);
        }
      ...
      for (; c < this._motionData.curveCount && v.at(c).type == J.CubismMotionCurveTarget_PartOpacity; ++c) m = e.getParameterIndex(v.at(c).id), m != -1 && (d = Yt(this._motionData, c, p), e.setParameterValueByIndex(m, d));
    ...
    parse(e, t) {
      ...
      const r = i.getEvaluationOptionFlag(It.EvaluationOptionFlag_AreBeziersRistricted);
      i.isExistMotionFadeInTime() ? this._fadeInSeconds = i.getMotionFadeInTime() < 0 ? 1 : i.getMotionFadeInTime() : this._fadeInSeconds = 1, i.isExistMotionFadeOutTime() ? this._fadeOutSeconds = i.getMotionFadeOutTime() < 0 ? 1 : i.getMotionFadeOutTime() : this._fadeOutSeconds = 1, this._motionData.curves.updateSize(this._motionData.curveCount, Ki, !0), this._motionData.segments.updateSize(i.getMotionTotalSegmentCount(), Zi, !0), this._motionData.points.updateSize(i.getMotionTotalPointCount(), Gt, !0), this._motionData.events.updateSize(this._motionData.eventCount, Qi, !0);
      let a = 0, o = 0;
      for (let n = 0; n < this._motionData.curveCount; ++n) {
        i.getMotionCurveTarget(n) == "Model" ? this._motionData.curves.at(n).type = J.CubismMotionCurveTarget_Model : i.getMotionCurveTarget(n) == "Parameter" ? this._motionData.curves.at(n).type = J.CubismMotionCurveTarget_Parameter : i.getMotionCurveTarget(n) == "PartOpacity" ? this._motionData.curves.at(n).type = J.CubismMotionCurveTarget_PartOpacity : ye('Warning : Unable to get segment type from Curve! The number of "CurveCount" may be incorrect!'), this._motionData.curves.at(n).id = i.getMotionCurveId(n), this._motionData.curves.at(n).baseSegmentIndex = o, this._motionData.curves.at(n).fadeInTime = i.isExistMotionCurveFadeInTime(n) ? i.getMotionCurveFadeInTime(n) : -1, this._motionData.curves.at(n).fadeOutTime = i.isExistMotionCurveFadeOutTime(n) ? i.getMotionCurveFadeOutTime(n) : -1;
        for (let l = 0; l < i.getMotionCurveSegmentCount(n); ) {
          switch (l == 0 ? (this._motionData.segments.at(o).basePointIndex = a, this._motionData.points.at(a).time = i.getMotionCurveSegment(n, l), this._motionData.points.at(a).value = i.getMotionCurveSegment(n, l + 1), a += 1, l += 2) : this._motionData.segments.at(o).basePointIndex = a - 1, i.getMotionCurveSegment(n, l)) {
            case ee.CubismMotionSegmentType_Linear:
              this._motionData.segments.at(o).segmentType = ee.CubismMotionSegmentType_Linear, this._motionData.segments.at(o).evaluate = mr, this._motionData.points.at(a).time = i.getMotionCurveSegment(n, l + 1), this._motionData.points.at(a).value = i.getMotionCurveSegment(n, l + 2), a += 1, l += 3;
              break;
            case ee.CubismMotionSegmentType_Bezier:
              this._motionData.segments.at(o).segmentType = ee.CubismMotionSegmentType_Bezier, this._motionData.segments.at(o).evaluate = r ? pr : fr, this._motionData.points.at(a).time = i.getMotionCurveSegment(n, l + 1), this._motionData.points.at(a).value = i.getMotionCurveSegment(n, l + 2), this._motionData.points.at(a + 1).time = i.getMotionCurveSegment(n, l + 3), this._motionData.points.at(a + 1).value = i.getMotionCurveSegment(n, l + 4), this._motionData.points.at(a + 2).time = i.getMotionCurveSegment(n, l + 5), this._motionData.points.at(a + 2).value = i.getMotionCurveSegment(n, l + 6), a += 3, l += 7;
              break;
            case ee.CubismMotionSegmentType_Stepped:
              this._motionData.segments.at(o).segmentType = ee.CubismMotionSegmentType_Stepped, this._motionData.segments.at(o).evaluate = yr, this._motionData.points.at(a).time = i.getMotionCurveSegment(n, l + 1), this._motionData.points.at(a).value = i.getMotionCurveSegment(n, l + 2), a += 1, l += 3;
              break;
            case ee.CubismMotionSegmentType_InverseStepped:
              this._motionData.segments.at(o).segmentType = ee.CubismMotionSegmentType_InverseStepped, this._motionData.segments.at(o).evaluate = xr, this._motionData.points.at(a).time = i.getMotionCurveSegment(n, l + 1), this._motionData.points.at(a).value = i.getMotionCurveSegment(n, l + 2), a += 1, l += 3;
              break;
            default:
              ae(0);
          }
    ...
    getFiredEvent(e, t) {
      ...
      for (let i = 0; i < this._motionData.eventCount; ++i) this._motionData.events.at(i).fireTime > e && this._motionData.events.at(i).fireTime <= t && this._firedEventValues.pushBack(new Q(this._motionData.events.at(i).value.s));
      return this._firedEventValues;
    }
    isExistModelOpacity() {
      for (let e = 0; e < this._motionData.curveCount; e++) {
        const t = this._motionData.curves.at(e);
        if (t.type == J.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Tt) == 0) return !0;
      }
      return !1;
    }
    getModelOpacityIndex() {
      if (this.isExistModelOpacity()) for (let e = 0; e < this._motionData.curveCount; e++) {
        const t = this._motionData.curves.at(e);
        if (t.type == J.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Tt) == 0) return e;
      }
      return -1;
    }
    getModelOpacityId(e) {
      if (e != -1) {
        const t = this._motionData.curves.at(e);
        if (t.type == J.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Tt) == 0) return V.getIdManager().getId(t.id.getString().s);
      }
      return null;
    }
    getModelOpacityValue() {
  ...
  class os {
    ...
    release() {
      this._autoDelete && this._motion && ze.delete(this._motion);
    }
    setFadeOut(e) {
  ...
  var us, hs, at, de, gs;
  (function(s) {
    s.CubismMotionQueueManager = ls, s.InvalidMotionQueueEntryHandleValue = Et;
  })(us || (us = {}));
  class Ht extends ls {
    constructor() {
  ...
  class cs {
    constructor() {
      this.normalizationPosition = new Wt(), this.normalizationAngle = new Wt();
    }
  }
  class _s {
    constructor() {
  ...
  class ms {
    constructor() {
      this.destination = new qt(), this.translationScale = new B(0, 0);
    }
  }
  class ps {
    constructor() {
  ...
  (function(s) {
    s.CubismPhysicsInput = _s, s.CubismPhysicsNormalization = Wt, s.CubismPhysicsOutput = ms, s.CubismPhysicsParameter = qt, s.CubismPhysicsParticle = ds, s.CubismPhysicsRig = ps, s.CubismPhysicsSource = de, s.CubismPhysicsSubRig = cs, s.CubismPhysicsTargetType = at, s.PhysicsJsonEffectiveForces = Sr;
  })(gs || (gs = {}));
  const nt = "Position", $t = "Angle", fs = "Type", ce = "Meta", Rt = "EffectiveForces", ys = "Gravity", xs = "Wind", k = "PhysicsSettings", je = "Normalization", Ss = "Minimum", Cs = "Maximum", Bs = "Default", vs = "Reflect", bs = "Weight", ot = "Input", Ie = "Output", Te = "Vertices";
  class Ms {
    constructor(e, t) {
      this._json = z.create(e, t);
    }
    ...
    getGravity() {
      const e = new B(0, 0);
      return e.x = this._json.getRoot().getValueByString(ce).getValueByString(Rt).getValueByString(ys).getValueByString("X").toFloat(), e.y = this._json.getRoot().getValueByString(ce).getValueByString(Rt).getValueByString(ys).getValueByString("Y").toFloat(), e;
    }
    getWind() {
      const e = new B(0, 0);
      return e.x = this._json.getRoot().getValueByString(ce).getValueByString(Rt).getValueByString(xs).getValueByString("X").toFloat(), e.y = this._json.getRoot().getValueByString(ce).getValueByString(Rt).getValueByString(xs).getValueByString("Y").toFloat(), e;
    }
    getFps() {
      return this._json.getRoot().getValueByString(ce).getValueByString("Fps").toFloat(0);
    }
    getSubRigCount() {
      return this._json.getRoot().getValueByString(ce).getValueByString("PhysicsSettingCount").toInt();
    }
    getTotalInputCount() {
      return this._json.getRoot().getValueByString(ce).getValueByString("TotalInputCount").toInt();
    }
    getTotalOutputCount() {
      return this._json.getRoot().getValueByString(ce).getValueByString("TotalOutputCount").toInt();
    }
    getVertexCount() {
      return this._json.getRoot().getValueByString(ce).getValueByString("VertexCount").toInt();
    }
    getNormalizationPositionMinimumValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString(nt).getValueByString(Ss).toFloat();
    }
    getNormalizationPositionMaximumValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString(nt).getValueByString(Cs).toFloat();
    }
    getNormalizationPositionDefaultValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString(nt).getValueByString(Bs).toFloat();
    }
    getNormalizationAngleMinimumValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString($t).getValueByString(Ss).toFloat();
    }
    getNormalizationAngleMaximumValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString($t).getValueByString(Cs).toFloat();
    }
    getNormalizationAngleDefaultValue(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(je).getValueByString($t).getValueByString(Bs).toFloat();
    }
    getInputCount(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(ot).getVector().getSize();
    }
    getInputWeight(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(ot).getValueByIndex(t).getValueByString(bs).toFloat();
    }
    getInputReflect(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(ot).getValueByIndex(t).getValueByString(vs).toBoolean();
    }
    getInputType(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(ot).getValueByIndex(t).getValueByString(fs).getRawString();
    }
    getInputSourceId(e, t) {
      return V.getIdManager().getId(this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(ot).getValueByIndex(t).getValueByString("Source").getValueByString("Id").getRawString());
    }
    getOutputCount(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getVector().getSize();
    }
    getOutputVertexIndex(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString("VertexIndex").toInt();
    }
    getOutputAngleScale(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString("Scale").toFloat();
    }
    getOutputWeight(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString(bs).toFloat();
    }
    getOutputDestinationId(e, t) {
      return V.getIdManager().getId(this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString("Destination").getValueByString("Id").getRawString());
    }
    getOutputType(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString(fs).getRawString();
    }
    getOutputReflect(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Ie).getValueByIndex(t).getValueByString(vs).toBoolean();
    }
    getParticleCount(e) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getVector().getSize();
    }
    getParticleMobility(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString("Mobility").toFloat();
    }
    getParticleDelay(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString("Delay").toFloat();
    }
    getParticleAcceleration(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString("Acceleration").toFloat();
    }
    getParticleRadius(e, t) {
      return this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString("Radius").toFloat();
    }
    getParticlePosition(e, t) {
      const i = new B(0, 0);
      return i.x = this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString(nt).getValueByString("X").toFloat(), i.y = this._json.getRoot().getValueByString(k).getValueByIndex(e).getValueByString(Te).getValueByIndex(t).getValueByString(nt).getValueByString("Y").toFloat(), i;
    }
  }
  var Ps;
  (function(s) {
  ...
  class lt {
    ...
    parse(e, t) {
      ...
      for (let n = 0; n < this._physicsRig.settings.getSize(); ++n) {
        ...
        for (let u = 0; u < this._physicsRig.settings.at(n).inputCount; ++u) this._physicsRig.inputs.at(r + u).sourceParameterIndex = -1, this._physicsRig.inputs.at(r + u).weight = i.getInputWeight(n, u), this._physicsRig.inputs.at(r + u).reflect = i.getInputReflect(n, u), i.getInputType(n, u) == "X" ? (this._physicsRig.inputs.at(r + u).type = de.CubismPhysicsSource_X, this._physicsRig.inputs.at(r + u).getNormalizedParameterValue = Cr) : i.getInputType(n, u) == "Y" ? (this._physicsRig.inputs.at(r + u).type = de.CubismPhysicsSource_Y, this._physicsRig.inputs.at(r + u).getNormalizedParameterValue = Br) : i.getInputType(n, u) == ws && (this._physicsRig.inputs.at(r + u).type = de.CubismPhysicsSource_Angle, this._physicsRig.inputs.at(r + u).getNormalizedParameterValue = vr), this._physicsRig.inputs.at(r + u).source.targetType = at.CubismPhysicsTargetType_Parameter, this._physicsRig.inputs.at(r + u).source.id = i.getInputSourceId(n, u);
        ...
        for (let u = 0; u < this._physicsRig.settings.at(n).outputCount; ++u) l.outputs.set(u, 0), h.outputs.set(u, 0), this._physicsRig.outputs.at(a + u).destinationParameterIndex = -1, this._physicsRig.outputs.at(a + u).vertexIndex = i.getOutputVertexIndex(n, u), this._physicsRig.outputs.at(a + u).angleScale = i.getOutputAngleScale(n, u), this._physicsRig.outputs.at(a + u).weight = i.getOutputWeight(n, u), this._physicsRig.outputs.at(a + u).destination.targetType = at.CubismPhysicsTargetType_Parameter, this._physicsRig.outputs.at(a + u).destination.id = i.getOutputDestinationId(n, u), i.getOutputType(n, u) == "X" ? (this._physicsRig.outputs.at(a + u).type = de.CubismPhysicsSource_X, this._physicsRig.outputs.at(a + u).getValue = br, this._physicsRig.outputs.at(a + u).getScale = wr) : i.getOutputType(n, u) == "Y" ? (this._physicsRig.outputs.at(a + u).type = de.CubismPhysicsSource_Y, this._physicsRig.outputs.at(a + u).getValue = Mr, this._physicsRig.outputs.at(a + u).getScale = Ir) : i.getOutputType(n, u) == ws && (this._physicsRig.outputs.at(a + u).type = de.CubismPhysicsSource_Angle, this._physicsRig.outputs.at(a + u).getValue = Pr, this._physicsRig.outputs.at(a + u).getScale = Tr), this._physicsRig.outputs.at(a + u).reflect = i.getOutputReflect(n, u);
    ...
    stabilization(e) {
      ...
      for (let M = 0; M < this._physicsRig.subRigCount; ++M) {
        ...
        l = P.degreesToRadian(-o.angle), u.x = u.x * P.cos(l) - u.y * P.sin(l), u.y = u.x * P.sin(l) + u.y * P.cos(l), Er(c, _.particleCount, u, o.angle, this._options.wind, 1e-3 * _.normalizationPosition.maximum);
        for (let f = 0; f < _.outputCount; ++f) {
          ...
          const E = d[f].destinationParameterIndex, I = !Float32Array.prototype.slice && "subarray" in Float32Array.prototype ? JSON.parse(JSON.stringify(m.subarray(E))) : m.slice(E);
          Jt(I, v[E], p[E], h, d[f]);
          for (let j = E, We = 0; j < this._parameterCaches.length; j++, We++) m[j] = this._parameterCaches[j] = I[We];
        }
      }
    }
    evaluate(e, t) {
      ...
      for (f = this._physicsRig.fps > 0 ? 1 / this._physicsRig.fps : t; this._currentRemainTime >= f; ) {
        ...
        for (let E = 0; E < this._physicsRig.subRigCount; ++E) {
          ...
          h = P.degreesToRadian(-n.angle), _.x = _.x * P.cos(h) - _.y * P.sin(h), _.y = _.x * P.sin(h) + _.y * P.cos(h), Vr(m, g.particleCount, _, n.angle, this._options.wind, 1e-3 * g.normalizationPosition.maximum, f, 5);
          for (let I = 0; I < g.outputCount; ++I) {
            const j = c[I].vertexIndex;
            if (c[I].destinationParameterIndex == -1 && (c[I].destinationParameterIndex = e.getParameterIndex(c[I].destination.id)), j < 1 || j >= g.particleCount) continue;
            const We = new B();
            We.x = m[j].position.x - m[j - 1].position.x, We.y = m[j].position.y - m[j - 1].position.y, u = c[I].getValue(We, m, j, c[I].reflect, this._options.gravity), this._currentRigOutputs.at(E).outputs.set(I, u);
            const _t = c[I].destinationParameterIndex, tr = !Float32Array.prototype.slice && "subarray" in Float32Array.prototype ? JSON.parse(JSON.stringify(this._parameterCaches.subarray(_t))) : this._parameterCaches.slice(_t);
            Jt(tr, x[_t], v[_t], u, c[I]);
            for (let ui = _t, ir = 0; ui < this._parameterCaches.length; ui++, ir++) this._parameterCaches[ui] = tr[ir];
          }
        }
    ...
    interpolate(e, t) {
      ...
      for (let l = 0; l < this._physicsRig.subRigCount; ++l) {
        ...
        for (let h = 0; h < r.outputCount; ++h) {
          ...
          Jt(_, n[u], o[u], this._previousRigOutputs.at(l).outputs.at(h) * (1 - t) + this._currentRigOutputs.at(l).outputs.at(h) * t, i[h]);
  ...
  function Cr(s, e, t, i, r, a, o, n, l, h) {
    s.x += Zt(t, i, r, 0, o.minimum, o.maximum, o.defalut, l) * h;
  }
  function Br(s, e, t, i, r, a, o, n, l, h) {
    s.y += Zt(t, i, r, 0, o.minimum, o.maximum, o.defalut, l) * h;
  }
  function vr(s, e, t, i, r, a, o, n, l, h) {
    e.angle += Zt(t, i, r, 0, n.minimum, n.maximum, n.defalut, l) * h;
  }
  ...
  function Zt(s, e, t, i, r, a, o, n) {
    let l = 0;
    const h = P.max(t, e);
    h < s && (s = h);
    const u = P.min(t, e);
    u > s && (s = u);
    const _ = P.min(r, a), g = P.max(r, a), d = o, c = (p = u, v = h, P.min(p, v) + function(x, M) {
      const f = P.max(x, M), D = P.min(x, M);
      return P.abs(f - D);
    }(p, v) / 2), m = s - c;
    var p, v;
    switch (function(x) {
  ...
  var Vs, Es;
  (function(s) {
    s.CubismPhysics = lt, s.Options = Is;
  })(Vs || (Vs = {}));
  class Ft {
    constructor(e, t, i, r) {
  ...
  class Kt {
    ...
    getMaskRenderTexture() {
      if (this._maskTexture && this._maskTexture.textures != null) this._maskTexture.frameNo = this._currentFrameNo;
        ...
        this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Lt), this._maskTexture = new Rs(this._currentFrameNo, this._maskRenderTextures);
      }
    ...
    calcClippedDrawTotalBounds(e, t) {
      ...
      for (let l = 0; l < n; l++) {
        ...
        const p = u * xe.vertexStep;
        for (let v = xe.vertexOffset; v < p; v += xe.vertexStep) {
          const x = _[v], M = _[v + 1];
    ...
    constructor() {
      this._currentMaskRenderTexture = null, this._maskColorBuffers = null, this._currentFrameNo = 0, this._renderTextureCount = 0, this._clippingMaskBufferSize = 256, this._clippingContextListForMask = new S(), this._clippingContextListForDraw = new S(), this._channelColors = new S(), this._tmpBoundsOnModel = new Ft(), this._tmpMatrix = new N(), this._tmpMatrixForMask = new N(), this._tmpMatrixForDraw = new N(), this._maskTexture = null;
      let e = new q();
      e.R = 1, e.G = 0, e.B = 0, e.A = 0, this._channelColors.pushBack(e), e = new q(), e.R = 0, e.G = 1, e.B = 0, e.A = 0, this._channelColors.pushBack(e), e = new q(), e.R = 0, e.G = 0, e.B = 1, e.A = 0, this._channelColors.pushBack(e), e = new q(), e.R = 0, e.G = 0, e.B = 0, e.A = 1, this._channelColors.pushBack(e);
    }
    release() {
    ...
    initialize(e, t, i, r, a) {
      a % 1 != 0 && (ye("The number of render textures must be specified as an integer. The decimal point is rounded down and corrected to an integer."), a = ~~a), a < 1 && ye("The number of render textures must be an integer greater than or equal to 1. Set the number of render textures to 1."), this._renderTextureCount = a < 1 ? 1 : a, this._clearedFrameBufferflags = new S(this._renderTextureCount);
      for (let o = 0; o < t; o++) {
        if (r[o] <= 0) {
    ...
    setupLayoutBounds(e) {
      ...
      if (e <= 0 || e > t) {
        e > t && G(`not supported mask count : {0}
...
[Details] render texture count : {1}, mask count : {2}`, e - t, this._renderTextureCount, e);
  ...
  class Fs {
    constructor(e, t, i) {
      this._owner = e, this._clippingIdList = t, this._clippingIdCount = i, this._allClippedDrawRect = new Ft(), this._layoutBounds = new Ft(), this._clippedDrawableIndexList = [], this._matrixForMask = new N(), this._matrixForDraw = new N(), this._bufferIndex = 0;
    }
    release() {
...
Please call 'CubimRenderer_WebGL.startUp' function.`);
  ...
  class Xe {
    static getInstance() {
      return Ve == null && (Ve = new Xe()), Ve;
    }
    static deleteInstance() {
      Ve && (Ve.release(), Ve = null);
    }
    constructor() {
    ...
    setupShaderProgram(e, t, i, r, a, o, n, l, h, u, _, g, d, c, m) {
      let p, v, x, M;
      if (d || G("NoPremultipliedAlpha is not allowed"), this._shaderSets.getSize() == 0 && this.generateShaders(), e.getClippingContextBufferForMask() != null) {
        const f = this._shaderSets.at(Ee.ShaderNames_SetupMask);
        ...
        switch (h) {
          ...
          default:
            T = this._shaderSets.at(Ee.ShaderNames_NormalPremultipliedAlpha + D), p = this.gl.ONE, v = this.gl.ONE_MINUS_SRC_ALPHA, x = this.gl.ONE, M = this.gl.ONE_MINUS_SRC_ALPHA;
            break;
          case $.CubismBlendMode_Additive:
            T = this._shaderSets.at(Ee.ShaderNames_AddPremultipliedAlpha + D), p = this.gl.ONE, v = this.gl.ONE, x = this.gl.ZERO, M = this.gl.ONE;
            break;
          case $.CubismBlendMode_Multiplicative:
            T = this._shaderSets.at(Ee.ShaderNames_MultPremultipliedAlpha + D), p = this.gl.DST_COLOR, v = this.gl.ONE_MINUS_SRC_ALPHA, x = this.gl.ZERO, M = this.gl.ONE;
        }
        if (this.gl.useProgram(T.shaderProgram), n.vertex == null && (n.vertex = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ARRAY_BUFFER, n.vertex), this.gl.bufferData(this.gl.ARRAY_BUFFER, r, this.gl.DYNAMIC_DRAW), this.gl.enableVertexAttribArray(T.attributePositionLocation), this.gl.vertexAttribPointer(T.attributePositionLocation, 2, this.gl.FLOAT, !1, 0, 0), n.uv == null && (n.uv = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ARRAY_BUFFER, n.uv), this.gl.bufferData(this.gl.ARRAY_BUFFER, o, this.gl.DYNAMIC_DRAW), this.gl.enableVertexAttribArray(T.attributeTexCoordLocation), this.gl.vertexAttribPointer(T.attributeTexCoordLocation, 2, this.gl.FLOAT, !1, 0, 0), f) {
          ...
          const I = e.getClippingContextBufferForDraw()._layoutChannelNo, j = e.getClippingContextBufferForDraw().getClippingManager().getChannelFlagAsColor(I);
          this.gl.uniform4f(T.uniformChannelFlagLocation, j.R, j.G, j.B, j.A);
        }
  ...
  const Fr = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_myPos;uniform mat4       u_clipMatrix;void main(){   gl_Position = u_clipMatrix * a_position;   v_myPos = u_clipMatrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}", Lr = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_myPos;uniform vec4       u_baseColor;uniform vec4       u_channelFlag;uniform sampler2D  s_texture0;void main(){   float isInside =        step(u_baseColor.x, v_myPos.x/v_myPos.w)       * step(u_baseColor.y, v_myPos.y/v_myPos.w)       * step(v_myPos.x/v_myPos.w, u_baseColor.z)       * step(v_myPos.y/v_myPos.w, u_baseColor.w);   gl_FragColor = u_channelFlag * texture2D(s_texture0, v_texCoord).a * isInside;}", Ar = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;uniform mat4       u_matrix;void main(){   gl_Position = u_matrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}", Ls = "attribute vec4     a_position;attribute vec2     a_texCoord;varying vec2       v_texCoord;varying vec4       v_clipPos;uniform mat4       u_matrix;uniform mat4       u_clipMatrix;void main(){   gl_Position = u_matrix * a_position;   v_clipPos = u_clipMatrix * a_position;   v_texCoord = a_texCoord;   v_texCoord.y = 1.0 - v_texCoord.y;}", Dr = "precision mediump float;varying vec2       v_texCoord;uniform vec4       u_baseColor;uniform sampler2D  s_texture0;uniform vec4       u_multiplyColor;uniform vec4       u_screenColor;void main(){   vec4 texColor = texture2D(s_texture0, v_texCoord);   texColor.rgb = texColor.rgb * u_multiplyColor.rgb;   texColor.rgb = (texColor.rgb + u_screenColor.rgb * texColor.a) - (texColor.rgb * u_screenColor.rgb);   vec4 color = texColor * u_baseColor;   gl_FragColor = vec4(color.rgb, color.a);}", kr = "precision mediump float;varying vec2       v_texCoord;varying vec4       v_clipPos;uniform vec4       u_baseColor;uniform vec4       u_channelFlag;uniform sampler2D  s_texture0;uniform sampler2D  s_texture1;uniform vec4       u_multiplyColor;uniform vec4       u_screenColor;void main(){   vec4 texColor = texture2D(s_texture0, v_texCoord);   texColor.rgb = texColor.rgb * u_multiplyColor.rgb;   texColor.rgb = (texColor.rgb + u_screenColor.rgb * texColor.a) - (texColor.rgb * u_screenColor.rgb);   vec4 col_formask = texColor * u_baseColor;   vec4 clipMask = (1.0 - texture2D(s_texture1, v_clipPos.xy / v_clipPos.w)) * u_channelFlag;   float maskVal = clipMask.r + clipMask.g + clipMask.b + clipMask.a;   col_formask = col_formask * maskVal;   gl_FragColor = col_formask;}", Or = "precision mediump float;varying vec2      v_texCoord;varying vec4      v_clipPos;uniform sampler2D s_texture0;uniform sampler2D s_texture1;uniform vec4      u_channelFlag;uniform vec4      u_baseColor;uniform vec4      u_multiplyColor;uniform vec4      u_screenColor;void main(){   vec4 texColor = texture2D(s_texture0, v_texCoord);   texColor.rgb = texColor.rgb * u_multiplyColor.rgb;   texColor.rgb = (texColor.rgb + u_screenColor.rgb * texColor.a) - (texColor.rgb * u_screenColor.rgb);   vec4 col_formask = texColor * u_baseColor;   vec4 clipMask = (1.0 - texture2D(s_texture1, v_clipPos.xy / v_clipPos.w)) * u_channelFlag;   float maskVal = clipMask.r + clipMask.g + clipMask.b + clipMask.a;   col_formask = col_formask * (1.0 - maskVal);   gl_FragColor = col_formask;}";
  class ei extends pt {
    initialize(e, t = 1) {
      e.isUsingMasking() && (this._clippingManager = new Kt(), this._clippingManager.initialize(e, e.getDrawableCount(), e.getDrawableMasks(), e.getDrawableMaskCounts(), t)), this._sortedDrawableIndexList.resize(e.getDrawableCount(), 0), super.initialize(e);
    }
    bindTexture(e, t) {
    ...
    setClippingMaskBufferSize(e) {
      ...
      this._clippingManager.release(), this._clippingManager = void 0, this._clippingManager = null, this._clippingManager = new Kt(), this._clippingManager.setClippingMaskBufferSize(e), this._clippingManager.initialize(this.getModel(), this.getModel().getDrawableCount(), this.getModel().getDrawableMasks(), this.getModel().getDrawableMaskCounts(), t);
    }
    getClippingMaskBufferSize() {
    ...
    constructor() {
      super(), this._clippingContextBufferForMask = null, this._clippingContextBufferForDraw = null, this._rendererProfile = new Rr(), this.firstDraw = !0, this._textures = new Y(), this._sortedDrawableIndexList = new S(), this._bufferData = { vertex: WebGLBuffer = null, uv: WebGLBuffer = null, index: WebGLBuffer = null }, this._textures.prepareCapacity(32, !0);
    }
    release() {
    ...
    doDrawModel() {
      if (this.gl == null) return void G(`'gl' is null. WebGLRenderingContext is required.
Please call 'CubimRenderer_WebGL.startUp' function.`);
        ...
        if (a != null && this.isUsingHighPrecisionMask()) {
          a._isUsing && (this.gl.viewport(0, 0, this._clippingManager.getClippingMaskBufferSize(), this._clippingManager.getClippingMaskBufferSize()), this.preDraw(), this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, a.getClippingManager().getMaskRenderTexture().at(a._bufferIndex)), this.gl.clearColor(1, 1, 1, 1), this.gl.clear(this.gl.COLOR_BUFFER_BIT));
          {
            ...
            for (let n = 0; n < o; n++) {
              ...
              this._model.getDrawableDynamicFlagVertexPositionsDidChange(l) && (this.setIsCulling(this._model.getDrawableCulling(l) != 0), this.setClippingContextBufferForMask(a), this.drawMesh(this.getModel().getDrawableTextureIndex(l), this.getModel().getDrawableVertexIndexCount(l), this.getModel().getDrawableVertexCount(l), this.getModel().getDrawableVertexIndices(l), this.getModel().getDrawableVertices(l), this.getModel().getDrawableVertexUvs(l), this.getModel().getMultiplyColor(l), this.getModel().getScreenColor(l), this.getModel().getDrawableOpacity(l), $.CubismBlendMode_Normal, !1));
            }
          }
          this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Lt), this.setClippingContextBufferForMask(null), this.gl.viewport(_e[0], _e[1], _e[2], _e[3]), this.preDraw();
        }
    ...
    drawMesh(e, t, i, r, a, o, n, l, h, u, _) {
      ...
      let d;
      this.getClippingContextBufferForMask() == null && (g.A *= h, this.isPremultipliedAlpha() && (g.R *= g.A, g.G *= g.A, g.B *= g.A)), d = this._textures.getValue(e) != null ? this._textures.getValue(e) : null, Xe.getInstance().setupShaderProgram(this, d, i, a, r, o, this._bufferData, h, u, g, n, l, this.isPremultipliedAlpha(), this.getMvpMatrix(), _), this.gl.drawElements(this.gl.TRIANGLES, t, this.gl.UNSIGNED_SHORT, 0), this.gl.useProgram(null), this.setClippingContextBufferForDraw(null), this.setClippingContextBufferForMask(null);
    }
    saveProfile() {
    ...
    startUp(e) {
      this.gl = e, this._clippingManager && this._clippingManager.setGL(e), Xe.getInstance().setGl(e), this._rendererProfile.setGl(e), this._extension = this.gl.getExtension("EXT_texture_filter_anisotropic") || this.gl.getExtension("WEBKIT_EXT_texture_filter_anisotropic") || this.gl.getExtension("MOZ_EXT_texture_filter_anisotropic");
    }
  }
  var As, Ds, ks;
  pt.staticRelease = () => {
    ...
    s.CubismClippingContext = Fs, s.CubismClippingManager_WebGL = Kt, s.CubismRenderTextureResource = Rs, s.CubismRenderer_WebGL = ei, s.CubismShaderSet = Qt, s.CubismShader_WebGL = Xe, s.ShaderNames = Ee;
  }(As || (As = {}));
  class Os {
    constructor(e = !1, t = new q()) {
  ...
  class Us {
    ...
    setPartOpacityByIndex(e, t) {
      this._notExistPartOpacities.isExist(e) ? this._notExistPartOpacities.setValue(e, t) : (ae(0 <= e && e < this.getPartCount()), this._partOpacities[e] = t);
    }
    ...
    getPartOpacityByIndex(e) {
      return this._notExistPartOpacities.isExist(e) ? this._notExistPartOpacities.getValue(e) : (ae(0 <= e && e < this.getPartCount()), this._partOpacities[e]);
    }
    ...
    getParameterValueByIndex(e) {
      return this._notExistParameterValues.isExist(e) ? this._notExistParameterValues.getValue(e) : (ae(0 <= e && e < this.getParameterCount()), this._parameterValues[e]);
    }
    ...
    getDrawableMultiplyColor(e) {
      const t = this._model.drawables.multiplyColors, i = 4 * e, r = new q();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
    getDrawableScreenColor(e) {
      const t = this._model.drawables.screenColors, i = 4 * e, r = new q();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
    ...
    getDrawableBlendMode(e) {
      const t = this._model.drawables.constantFlags;
      return Live2DCubismCore.Utils.hasBlendAdditiveBit(t[e]) ? $.CubismBlendMode_Additive : Live2DCubismCore.Utils.hasBlendMultiplicativeBit(t[e]) ? $.CubismBlendMode_Multiplicative : $.CubismBlendMode_Normal;
    }
    ...
    initialize() {
      ae(this._model), this._parameterValues = this._model.parameters.values, this._partOpacities = this._model.parts.opacities, this._parameterMaximumValues = this._model.parameters.maximumValues, this._parameterMinimumValues = this._model.parameters.minimumValues;
      {
      ...
      }
      {
        ...
        const r = new Nr(!1, !1);
        for (let a = 0; a < e; ++a) {
          const o = new q(1, 1, 1, 1), n = new q(0, 0, 0, 1), l = new Ns(!1, o), h = new Ns(!1, n);
        ...
        for (let a = 0; a < i; ++a) {
          const o = new q(1, 1, 1, 1), n = new q(0, 0, 0, 1), l = new Os(!1, o), h = new Os(!1, n);
  ...
  class ut {
    static create(e, t) {
      let i = null;
      if (t && !this.hasMocConsistency(e)) return G("Inconsistent MOC3."), i;
      const r = Live2DCubismCore.Moc.fromArrayBuffer(e);
      return r && (i = new ut(r), i._mocVersion = Live2DCubismCore.Version.csmGetMocVersion(r, e)), i;
    }
    static delete(e) {
    ...
    release() {
      ae(this._modelCount == 0), this._moc._release(), this._moc = null;
    }
    getLatestMocVersion() {
  ...
  class js {
    ...
    getUserDataTargetType(e) {
      return this._json.getRoot().getValueByString(ti).getValueByIndex(e).getValueByString("Target").getRawString();
    }
    getUserDataId(e) {
      return V.getIdManager().getId(this._json.getRoot().getValueByString(ti).getValueByIndex(e).getValueByString("Id").getRawString());
    }
    getUserDataValue(e) {
      return this._json.getRoot().getValueByString(ti).getValueByIndex(e).getValueByString("Value").getRawString();
    }
  }
  var Xs, Gs, Ys;
  (function(s) {
  ...
  class ht {
    ...
    parseUserData(e, t) {
      ...
      for (let o = 0; o < a; o++) {
        const n = new Hs();
        n.targetId = i.getUserDataId(o), n.targetType = V.getIdManager().getId(i.getUserDataTargetType(o)), n.value = new Q(i.getUserDataValue(o)), this._userDataNodes.pushBack(n), n.targetType == r && this._artMeshUserDataNode.pushBack(n);
      }
      i.release(), i = void 0;
    }
    constructor() {
  ...
  (function(s) {
    s.CubismModelUserData = ht, s.CubismModelUserDataNode = Hs;
  })(Gs || (Gs = {}));
  class At {
    isInitialized() {
    ...
    loadModel(e, t = !1) {
      this._moc = ut.create(e, t), this._moc != null ? (this._model = this._moc.createModel(), this._model != null ? (this._model.saveParameters(), this._modelMatrix = new Yi(this._model.getCanvasWidth(), this._model.getCanvasHeight())) : G("Failed to CreateModel().")) : G("Failed to CubismMoc.create().");
    }
    loadExpression(e, t, i) {
      return Mt.create(e, t);
    }
    loadPose(e, t) {
      this._pose = st.create(e, t);
    }
    loadUserData(e, t) {
      this._modelUserData = ht.create(e, t);
    }
    loadPhysics(e, t) {
      this._physics = lt.create(e, t);
    }
    isHit(e, t, i) {
      ...
      for (let d = 1; d < a; ++d) {
        const c = o[xe.vertexOffset + d * xe.vertexStep], m = o[xe.vertexOffset + d * xe.vertexStep + 1];
    ...
    createRenderer(e = 1) {
      this._renderer && this.deleteRenderer(), this._renderer = new ei(), this._renderer.initialize(this._model, e);
    }
    deleteRenderer() {
    ...
    constructor() {
      this.loadMotion = (e, t, i, r) => Vt.create(e, t, r), this._moc = null, this._model = null, this._motionManager = null, this._expressionManager = null, this._eyeBlink = null, this._breath = null, this._modelMatrix = null, this._pose = null, this._dragManager = null, this._physics = null, this._modelUserData = null, this._initialized = !1, this._updating = !1, this._opacity = 1, this._lipsync = !0, this._lastLipSyncValue = 0, this._dragX = 0, this._dragY = 0, this._accelerationX = 0, this._accelerationY = 0, this._accelerationZ = 0, this._mocConsistency = !1, this._debugMode = !1, this._renderer = null, this._motionManager = new Ht(), this._motionManager.setEventCallback(At.cubismDefaultMotionEventCallback, this), this._expressionManager = new Ht(), this._dragManager = new Hi();
    }
    release() {
      this._motionManager != null && (this._motionManager.release(), this._motionManager = null), this._expressionManager != null && (this._expressionManager.release(), this._expressionManager = null), this._moc != null && (this._moc.deleteModel(this._model), this._moc.release(), this._moc = null), this._modelMatrix = null, st.delete(this._pose), we.delete(this._eyeBlink), it.delete(this._breath), this._dragManager = null, lt.delete(this._physics), ht.delete(this._modelUserData), this.deleteRenderer();
    }
  }
  (function(s) {
    s.CubismUserModel = At;
  })(Ys || (Ys = {}));
  const Ur = "background-color: #CB81DA; color: white; padding: 3px; border-radius: 3px;";
  function qs(s) {
    console.log("%c" + s, Ur);
  }
  var ii = function(s, e, t, i) {
    ...
    return ii(this, void 0, void 0, function* () {
      if (!Ws.refreshCache && b.LoadFromCache && b.Live2dDB) {
        ...
        if (r !== void 0) {
          ...
          return { arrayBuffer: () => ii(this, void 0, void 0, function* () {
            return a;
          }) };
        }
      }
      ...
      }({ url: s, arraybuffer: i }), { arrayBuffer: () => ii(this, void 0, void 0, function* () {
        return i;
      }) };
    });
  }
  class H {
    static loadFileAsBytes(e, t) {
      ie(e).then((i) => i.arrayBuffer()).then((i) => t(i, i.byteLength));
    }
    static getDeltaTime() {
  ...
  H.lastUpdate = Date.now(), H.s_currentFrame = 0, H.s_lastFrame = 0, H.s_deltaTime = 0;
  ...
  class si {
    static getInstance() {
      return Ge == null && (Ge = new si()), Ge;
    }
    static releaseInstance() {
      Ge != null && (Ge = void 0), Ge = null;
    }
    update(e) {
      let t, i;
    ...
    loadWavFile(e) {
      ...
      const i = () => $s(this, void 0, void 0, function* () {
        return ie(e).then((r) => r.arrayBuffer());
      });
    ...
    constructor() {
      ...
      }, this._pcmData = null, this._userTimeSeconds = 0, this._lastRms = 0, this._sampleOffset = 0, this._wavFileInfo = new zr(), this._byteReader = new jr();
    }
  }
  class zr {
    constructor() {
  ...
  class Xr extends At {
    loadAssets(e, t) {
      return Js(this, void 0, void 0, function* () {
        ...
        const i = yield ie(t), r = yield i.arrayBuffer(), a = new Di(r, r.byteLength);
    ...
    setupModel(e) {
      if (this._updating = !0, this._initialized = !1, this._modelSetting = e, this._modelSetting.getModelFileName() != "") {
        ...
        ie(`${this._modelHomeDir}${g}`).then((d) => d.arrayBuffer()).then((d) => {
      ...
      const t = () => {
        if (this._modelSetting.getExpressionCount() > 0) {
          ...
          for (let d = 0; d < g; ++d) {
            ...
            ie(`${this._modelHomeDir}${m}`).then((p) => p.arrayBuffer()).then((p) => {
              const v = this.loadExpression(p, p.byteLength, c);
              this._expressions.getValue(c) != null && (ze.delete(this._expressions.getValue(c)), this._expressions.setValue(c, null)), this._expressions.setValue(c, v), this._expressionCount++, this._expressionCount >= g && (this._state = F.LoadPhysics, i());
            });
          }
        ...
        this._modelSetting.getEyeBlinkParameterCount() > 0 && (this._eyeBlink = we.create(this._modelSetting), this._state = F.SetupBreath), o();
      }, o = () => {
        this._breath = it.create();
        const g = new S();
        g.pushBack(new Ue(this._idParamAngleX, 0, 15, 6.5345, 0.5)), g.pushBack(new Ue(this._idParamAngleY, 0, 8, 3.5345, 0.5)), g.pushBack(new Ue(this._idParamAngleZ, 0, 10, 5.5345, 0.5)), g.pushBack(new Ue(this._idParamBodyAngleX, 0, 4, 15.5345, 0.5)), g.pushBack(new Ue(V.getIdManager().getId(C.ParamBreath), 0.5, 0.5, 3.2345, 1)), this._breath.setParameters(g), this._state = F.LoadUserData, n();
      }, n = () => {
        ...
        const g = new Y();
        this._modelSetting != null && this._modelMatrix != null ? (this._modelSetting.getLayoutMap(g), this._modelMatrix.setupFromLayout(g), this._state = F.LoadMotion, _()) : G("Failed to setupLayout().");
      }, _ = () => {
    ...
    setupTextures() {
      if (this._state == F.LoadTexture) {
        ...
        for (let t = 0; t < e; t++) {
          ...
          O.getInstance().getTextureManager().createTextureFromFile(i, !0, r), this.getRenderer().setIsPremultipliedAlpha(!0);
        }
    ...
    startMotion(e, t, i, r) {
      ...
      else if (!this._motionManager.reserveMotion(i)) return this._debugMode && H.printMessage("[APP]can't start motion."), Et;
      const a = this._modelSetting.getMotionFileName(e, t), o = `${e}_${t}`;
      let n = this._motions.getValue(o), l = !1;
      n == null ? ie(`${this._modelHomeDir}${a}`).then((u) => u.arrayBuffer()).then((u) => {
      ...
      return this._debugMode && H.printMessage(`[APP]start motion: [${e}_${t}`), this._motionManager.startMotionPriority(n, l, i);
    }
    startRandomMotion(e, t, i) {
      if (this._modelSetting.getMotionCount(e) == 0) return Et;
    ...
    setExpression(e) {
      ...
      this._debugMode && H.printMessage(`[APP]expression: [${e}]`), t != null ? this._expressionManager.startMotionPriority(t, !0, b.PriorityForce) : this._debugMode && H.printMessage(`[APP]expression[${e}] is null`);
    }
    setRandomExpression() {
    ...
    motionEventFired(e) {
      ne("{0} is fired on LAppModel!!", e.s);
    }
    hitTest(e, t, i) {
    ...
    doDraw() {
      ...
      this.getRenderer().setRenderState(oi, e), this.getRenderer().drawModel();
    }
    draw(e) {
    ...
    hasMocConsistencyFromFile() {
      return Js(this, void 0, void 0, function* () {
        if (ae(this._modelSetting.getModelFileName().localeCompare("")), this._modelSetting.getModelFileName() != "") {
          const e = this._modelSetting.getModelFileName(), t = yield ie(`${this._modelHomeDir}${e}`), i = yield t.arrayBuffer();
          return this._consistency = ut.hasMocConsistency(i), this._consistency ? ne("Consistent MOC3.") : ne("Inconsistent MOC3."), this._consistency;
        }
      });
    }
    constructor() {
      super(), this._modelSetting = null, this._modelHomeDir = null, this._userTimeSeconds = 0, this._eyeBlinkIds = new S(), this._lipSyncIds = new S(), this._motions = new Y(), this._expressions = new Y(), this._hitArea = new S(), this._userArea = new S(), this._idParamAngleX = V.getIdManager().getId(C.ParamAngleX), this._idParamAngleY = V.getIdManager().getId(C.ParamAngleY), this._idParamAngleZ = V.getIdManager().getId(C.ParamAngleZ), this._idParamEyeBallX = V.getIdManager().getId(C.ParamEyeBallX), this._idParamEyeBallY = V.getIdManager().getId(C.ParamEyeBallY), this._idParamBodyAngleX = V.getIdManager().getId(C.ParamBodyAngleX), this._mocConsistency = !0, this._state = F.LoadAssets, this._expressionCount = 0, this._textureCount = 0, this._motionCount = 0, this._allMotionCount = 0, this._wavFileHandler = new si(), this._consistency = !1;
    }
  }
  const Gr = `
...
`;
  ...
  const ri = 35, me = "#00A6ED", $r = "white", Dt = "rgb(224, 209, 41)";
  let se, Ye, ai = !1, Zs = 35;
  const pe = "__live2d-toolbox-item";
  function gt() {
    se && (Ye && clearTimeout(Ye), Ye = setTimeout(() => {
      se.style.opacity = "1";
    }, 200));
  }
  function dt() {
    se && !ai && (Ye && clearTimeout(Ye), Ye = setTimeout(() => {
      se.style.opacity = "0";
    }, 200));
  }
  function ct(s, e = "", t = []) {
    const i = document.createElement("div");
    i.classList.add(pe), t.forEach((o) => i.classList.add(o));
  ...
  function Jr(s) {
    const e = ct(qr, "", ["button-item"]);
    return e.style.backgroundColor = me, e.style.fontSize = "1.05rem", e.addEventListener("mouseenter", () => {
      e.style.backgroundColor = Dt;
    }), e.addEventListener("mouseleave", () => {
      e.style.backgroundColor = me;
    }), e.onclick = () => ge(this, void 0, void 0, function* () {
  ...
  function Ks() {
    ...
    const e = b.Canvas;
    s.style.zIndex = parseInt(e.style.zIndex) + 1 + "", s.style.opacity = "0", s.style.transition = ".7s cubic-bezier(0.23, 1, 0.32, 1)", s.style.position = "fixed", s.style.right = e.width - Zs + "px", s.style.top = window.innerHeight - e.height + "px";
    const t = function(o) {
      const n = ct(Gr, "", ["button-item"]);
      n.style.backgroundColor = me, n.style.fontSize = "1.05rem", n.addEventListener("mouseenter", () => {
        n.style.backgroundColor = Dt;
      }), n.addEventListener("mouseleave", () => {
        n.style.backgroundColor = me;
      });
      let l = 0;
      return n.onclick = () => ge(this, void 0, void 0, function* () {
        const h = b.Canvas;
        if (h) {
          const u = Math.ceil(h.width);
          l = (l + u) % (u << 1), h.style.transform = `translateX(${l}px)`, o.style.transform = `translateX(${Math.max(0, l - Zs)}px)`, l > 0 ? (ai = !0, n.style.transform = "rotate(180deg)", setTimeout(() => {
            gt();
          }, 500)) : (ai = !1, n.style.transform = "rotate(0)");
        }
      }), n;
    }(s), i = function(o) {
      const n = ct(Yr, "", ["button-item"]);
      n.style.backgroundColor = me, n.style.fontSize = "1.05rem", n.style.position = "relative";
      ...
      l.style.transform = `translate(-75px, ${h - 50}px)`, n.addEventListener("mouseenter", () => {
        n.style.backgroundColor = Dt, l.style.visibility = "visible", l.style.opacity = "1", l.style.transform = `translate(-75px, ${h}px)`;
      }), n.addEventListener("mouseleave", () => {
        n.style.backgroundColor = me, l.style.opacity = "0", l.style.transform = `translate(-75px, ${h - 50}px)`, setTimeout(() => {
      ...
      const u = function(_) {
        const g = re.getInstance(), d = b.Canvas, c = [];
        if (g && d) {
          const m = Math.max(0, Math.floor(d.height / ri) - 1), p = g.getModel(0), v = Math.min(p._expressions.getSize(), m);
          for (let x = 0; x < v; ++x) {
            const M = p._expressions._keyValues[x].first, f = M.replace(".exp3.json", ""), D = ct(Wr, f);
            D.classList.add("expression-item"), D.onclick = () => ge(this, void 0, void 0, function* () {
              p.setExpression(M);
            }), c.push(D);
          }
        }
      ...
      const n = ct(Hr, "", ["button-item"]);
      return n.style.backgroundColor = me, n.style.fontSize = "1.05rem", n.addEventListener("mouseenter", () => {
        n.style.backgroundColor = Dt;
      }), n.addEventListener("mouseleave", () => {
        n.style.backgroundColor = me;
      }), n.onclick = () => ge(this, void 0, void 0, function* () {
        Ws.refreshCache = !0, re.getInstance().loadLive2dModel();
      }), n;
    }(), a = Jr();
  ...
  class re {
    static getInstance() {
      return He == null && (He = new re()), He;
    }
    static releaseInstance() {
      He != null && (He = void 0), He = null;
    }
    getModel(e) {
    ...
    onTap(e, t) {
      H.printMessage(`[APP]tap point: {x: ${e.toFixed(2)} y: ${t.toFixed(2)}}`);
    ...
    onUpdate() {
      ...
      for (let r = 0; r < i; ++r) {
        const a = new N(), o = this.getModel(r);
    ...
    loadLive2dModel() {
      return e = this, t = void 0, r = function* () {
        ...
        this._models.pushBack(n), yield n.loadAssets(o, a), setTimeout(() => {
          (function() {
            se && (dt(), document.body.removeChild(se), se = Ks(), gt(), se.onmouseenter = () => ge(this, void 0, void 0, function* () {
              gt();
            }), se.onmouseleave = () => ge(this, void 0, void 0, function* () {
              dt();
            }));
          })();
    ...
    constructor() {
      this._finishedMotion = (e) => {
        console.log(e);
      }, this._viewMatrix = new N(), this._models = new S(), this.loadLive2dModel();
    }
  }
  var Qs;
  class Zr {
    ...
    createTextureFromFile(e, t, i) {
      return r = this, a = void 0, n = function* () {
        ...
        const h = e.split(".").at(-1).toLowerCase(), u = yield ie(e), _ = yield u.arrayBuffer(), g = new Blob([_], { type: "image/" + h }), d = URL.createObjectURL(g);
        l.src = d;
  ...
  class er extends N {
    ...
    adjustScale(e, t, i) {
      ...
      N.multiply(h, this._tr, this._tr), N.multiply(l, this._tr, this._tr), N.multiply(n, this._tr, this._tr);
    }
  ...
  class ea {
    constructor() {
      this._programId = null, this._touchManager = new Qr(), this._deviceToScreen = new N(), this._viewMatrix = new er();
    }
    initialize() {
    ...
    initializeSprite() {
      R.width, R.height, O.getInstance().getTextureManager(), this._programId == null && (this._programId = O.getInstance().createShader());
    }
    onTouchesBegan(e, t) {
    ...
    onTouchesMoved(e, t) {
      ...
      this._touchManager.touchesMoved(e, t), re.getInstance().onDrag(i, r);
    }
    onTouchesEnded(e, t) {
  ...
  class qe {
    ...
    static getInstance() {
      return ni == null && (ni = new qe()), ni;
    }
    getMessageBox() {
      return this._messageBox == null && (this._messageBox = document.querySelector("#live2dMessageBox-content")), this._messageBox;
    }
    initialize(e) {
      return K = document.createElement("div"), K.id = b.MessageBoxId, K.style.position = "fixed", K.style.padding = "10px", K.style.zIndex = "9999", K.style.display = "flex", K.style.justifyContent = "center", K.style.width = e.width + "px", K.style.height = "20px", K.style.right = "0", K.style.bottom = e.height + 50 + "px", K.innerHTML = '<div id="live2dMessageBox-content"></div>', document.body.appendChild(K), this.hideMessageBox(), !0;
    }
    setMessage(e, t = null) {
  ...
  class O {
    ...
    release() {
      this._textureManager.release(), this._textureManager = null, this._view.release(), this._view = null, re.releaseInstance(), V.dispose();
    }
    run() {
      const e = () => {
        Re != null && (H.updateTime(), y.clearColor(...b.BackgroundRGBA), y.enable(y.DEPTH_TEST), y.depthFunc(y.LEQUAL), y.clear(y.COLOR_BUFFER_BIT | y.DEPTH_BUFFER_BIT), y.clearDepth(1), y.enable(y.BLEND), y.blendFunc(y.SRC_ALPHA, y.ONE_MINUS_SRC_ALPHA), this._view.render(), requestAnimationFrame(e));
      };
      e();
    }
    createShader() {
    ...
    constructor() {
      this._captured = !1, this._mouseX = 0, this._mouseY = 0, this._isEnd = !1, this._cubismOption = new lr(), this._view = new ea(), this._textureManager = new Zr();
    }
    initializeCubism() {
      this._cubismOption.logFunction = H.printMessage, this._cubismOption.loggingLevel = b.CubismLoggingLevel, V.startUp(this._cubismOption), V.initialize(), re.getInstance(), H.updateTime();
    }
    _resizeCanvas() {
  ...
  function ta(s) {
    O.getInstance()._view ? re.getInstance().model.setRandomExpression() : H.printMessage("view notfound");
  }
  function ia(s) {
  ...
  function sa(s) {
    if (O.getInstance()._captured = !1, !O.getInstance()._view) return;
    const e = s.target.getBoundingClientRect(), t = s.clientX - e.left, i = s.clientY - e.top;
    O.getInstance()._view.onTouchesEnded(t, i);
  }
  function ra(s) {
    const e = O.getInstance();
    if (!e._view) return;
...
.${pe}.expression-item > span:last-child {
    width: 60px;
    overflow: hidden;
    white-space: nowrap;
...
`, document.head.appendChild(r);
                })(), se = Ks(), dt(), se.onmouseenter = () => ge(this, void 0, void 0, function* () {
                  gt();
                }), se.onmouseleave = () => ge(this, void 0, void 0, function* () {
                  dt();
                });
                const i = b.Canvas;
                i.onmouseenter = () => ge(this, void 0, void 0, function* () {
                  gt();
                }), i.onmouseleave = () => ge(this, void 0, void 0, function* () {
                  dt();
                });
              }();
...
function pa() {
  ...
  const fe = window.devicePixelRatio || 1, Fe = parseInt(L.style.width) || L.width, $e = parseInt(L.style.height) || L.height;
  L.width = Fe * fe, L.height = $e * fe, L.style.width = Fe + "px", L.style.height = $e + "px";
  const Je = L.getContext("webgl") || L.getContext("experimental-webgl");
  Je && Je.viewport(0, 0, L.width, L.height);
  const $ = ((performance.now() - rr) / 1e3).toFixed(2);
  console.log(`[Live2D] ✅ 米塔已就绪 (总耗时: ${$}秒)`);
}
function ar(L = 0, fe = 10) {
  if (document.getElementById("live2d")) {
    pa();
    return;
  }
  L < fe ? setTimeout(() => ar(L + 1, fe), 100) : console.warn("[Live2D] ⚠️ Canvas 创建超时");
}
async function fa() {
  try {
    console.log("[Live2D] 开始加载米塔模型（约7MB，请耐心等待）..."), await ma.initializeLive2D({
      // live2d 所在区域的背景颜色（透明）
    ...
    const L = ((performance.now() - rr) / 1e3).toFixed(2);
    console.log(`[Live2D] ✅ 模型加载完成 (耗时: ${L}秒)`), ar();
  } catch (L) {
