...
`:
  ...
  class jt extends D {
    ...
    getValueByIndex(e) {
      if (e < 0 || this._array.getSize() <= e) return D.errorValue.setErrorNotForClientCall("Error: index out of bounds");
...
`, this._stringBuffer;
  ...
  }(), bi = "FormData" in W, wt = "ArrayBuffer" in W;
  ...
  function G(s) {
    this.map = {}, s instanceof G ? s.forEach(function(e, t) {
      this.append(t, e);
  ...
  function Pi() {
    return this.bodyUsed = !1, this._initBody = function(s) {
      ...
      var s, e, t, i = Yt(this);
      if (i) return i;
      if (this._bodyBlob) return s = this._bodyBlob, t = Mi(e = new FileReader()), e.readAsText(s), t;
  ...
  function Re(s, e) {
    ...
    if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new G(e.headers)), this.method = (i = (t = e.method || this.method || "GET").toUpperCase(), pr.indexOf(i) > -1 ? i : t), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && r) throw new TypeError("Body not allowed for GET or HEAD requests");
  ...
  function Ii(s, e) {
    return new Promise(function(t, i) {
      ...
      a.onload = function() {
        var n, l, h = { status: a.status, statusText: a.statusText, headers: (n = a.getAllResponseHeaders() || "", l = new G(), n.replace(/\r?\n[\t ]+/g, " ").split("\r").map(function(_) {
          return _.indexOf(`
`) === 0 ? _.substr(1, _.length) : _;
      ...
      }(r.url), !0), r.credentials === "include" ? a.withCredentials = !0 : r.credentials === "omit" && (a.withCredentials = !1), "responseType" in a && (Mt ? a.responseType = "blob" : wt && r.headers.get("Content-Type") && r.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (a.responseType = "arraybuffer")), !e || typeof e.headers != "object" || e.headers instanceof G ? r.headers.forEach(function(n, l) {
  ...
  class Ui extends Vi {
    ...
    getTextureDirectory() {
      const e = this._jsonValue.at(I.FrequestNode_Textures).getValueByIndex(0).getRawString().split("/"), t = e.length - 1;
      let i = "";
  ...
  class Tt extends We {
    ...
    parse(e, t) {
      const i = H.create(e, t), r = i.getRoot();
  ...
  function Sr(s, e) {
    ...
    t < 0 && (t = 0);
    const i = ae(s[0], s[1], t), r = ae(s[1], s[2], t), a = ae(s[2], s[3], t), o = ae(i, r, t), n = ae(r, a, t);
    return ae(o, n, t).value;
  }
  function Cr(s, e) {
    const t = e, i = s[0].time, r = s[3].time, a = s[1].time, o = s[2].time, n = r - 3 * o + 3 * a - i, l = 3 * o - 6 * a + 3 * i, h = 3 * a - 3 * i, u = i - t, _ = P.cardanoAlgorithmForBezier(n, l, h, u), g = ae(s[0], s[1], _), d = ae(s[1], s[2], _), c = ae(s[2], s[3], _), m = ae(g, d, _), p = ae(d, c, _);
  ...
  class Ft extends We {
    ...
    doUpdateParameters(e, t, i, r) {
      ...
      for (; c < this._motionData.curveCount && b.at(c).type == ee.CubismMotionCurveTarget_Parameter; ++c) {
        if (m = e.getParameterIndex(b.at(c).id), m == -1) continue;
    ...
    isExistModelOpacity() {
      for (let e = 0; e < this._motionData.curveCount; e++) {
        ...
        if (t.type == ee.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Rt) == 0) return !0;
      }
      return !1;
    }
    getModelOpacityIndex() {
  ...
  function ti(s, e, t, i, r, a, o, n) {
    ...
    const u = P.min(t, e);
    u > s && (s = u);
    const _ = P.min(r, a), g = P.max(r, a), d = o, c = (p = u, b = h, P.min(p, b) + function(S, w) {
...
Please call 'CubimRenderer_WebGL.startUp' function.`);
  ...
  class Je {
    ...
    loadShaderProgram(e, t) {
      ...
      if (!r) return $("Vertex shader compile error!"), 0;
...
Please call 'CubimRenderer_WebGL.startUp' function.`);
  ...
  class Gs {
    ...
    getDrawableMultiplyColor(e) {
      const t = this._model.drawables.multiplyColors, i = 4 * e, r = new K();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
    getDrawableScreenColor(e) {
      const t = this._model.drawables.screenColors, i = 4 * e, r = new K();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
  ...
  class qr extends Nt {
    loadAssets(e, t) {
      return er(this, void 0, void 0, function* () {
        ...
        const i = yield ne(t), r = yield i.arrayBuffer(), a = new Ui(r, r.byteLength);
    ...
    update() {
      if (this._state != A.CompleteSetup) return;
    ...
    startMotion(e, t, i, r) {
      if (i == M.PriorityForce) this._motionManager.setReservePriority(i);
      else if (!this._motionManager.reserveMotion(i)) return this._debugMode && Z.printMessage("[APP]can't start motion."), At;
      const a = this._modelSetting.getMotionFileName(e, t), o = `${e}_${t}`;
      let n = this._motions.getValue(o), l = !1;
      n == null ? ne(`${this._modelHomeDir}${a}`).then((u) => u.arrayBuffer()).then((u) => {
    ...
    startRandomMotion(e, t, i) {
      if (this._modelSetting.getMotionCount(e) == 0) return At;
  ...
  class ta {
    ...
    createTextureFromFile(e, t, i) {
      return r = this, a = void 0, n = function* () {
        ...
        const h = e.split(".").at(-1).toLowerCase(), u = yield ne(e), _ = yield u.arrayBuffer(), g = new Blob([_], { type: "image/" + h }), d = URL.createObjectURL(g);
        l.src = d;
