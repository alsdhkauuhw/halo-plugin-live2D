var rr = { exports: {} };
(function() {
  var ht, ni, oi, li, ui, se, hi, gt = { d: function(s, e) {
  ...
  gt.r(Ft), gt.d(Ft, { hideMessageBox: function() {
    return ha;
...
`);
  ...
  class U {
    ...
    parseBytes(e, t, i) {
      const r = new Array(1), a = U.arrayBufferToString(e);
...
`:
  ...
  class Lt extends L {
    ...
    getValueByIndex(e) {
      if (e < 0 || this._array.getSize() <= e) return L.errorValue.setErrorNotForClientCall("Error: index out of bounds");
...
`, this._stringBuffer;
  ...
  let oe = !1, Le = !1, Ae = null, $e = null;
  const fe = Object.freeze({ vertexOffset: 0, vertexStep: 2 });
  function nr(s) {
  }
  class V {
    static startUp(e = null) {
      if (oe) return ae("CubismFramework.startUp() is already done."), oe;
  ...
  function N(s) {
    this.map = {}, s instanceof N ? s.forEach(function(e, t) {
      this.append(t, e);
  ...
  function be(s, e) {
    ...
    if (this.credentials = e.credentials || this.credentials || "same-origin", !e.headers && this.headers || (this.headers = new N(e.headers)), this.method = (i = (t = e.method || this.method || "GET").toUpperCase(), gr.indexOf(i) > -1 ? i : t), this.mode = e.mode || this.mode || null, this.signal = e.signal || this.signal, this.referrer = null, (this.method === "GET" || this.method === "HEAD") && r) throw new TypeError("Body not allowed for GET or HEAD requests");
  ...
  function le(s, e) {
    if (!(this instanceof le)) throw new TypeError('Please use the "new" operator, this DOM object constructor cannot be called as a function.');
  ...
  be.prototype.clone = function() {
    ...
    var s = new le(null, { status: 0, statusText: "" });
    return s.type = "error", s;
  };
  var cr = [301, 302, 303, 307, 308];
  le.redirect = function(s, e) {
    if (cr.indexOf(e) === -1) throw new RangeError("Invalid status code");
    return new le(null, { status: e, headers: { location: s } });
  };
  var De = j.DOMException;
  try {
    new De();
  } catch {
    (De = function(e, t) {
  ...
  function bi(s, e) {
    return new Promise(function(t, i) {
      var r = new be(s, e);
      if (r.signal && r.signal.aborted) return i(new De("Aborted", "AbortError"));
      var a = new XMLHttpRequest();
      function o() {
        a.abort();
      }
      a.onload = function() {
        var n, l, h = { status: a.status, statusText: a.statusText, headers: (n = a.getAllResponseHeaders() || "", l = new N(), n.replace(/\r?\n[\t ]+/g, " ").split("\r").map(function(_) {
          return _.indexOf(`
`) === 0 ? _.substr(1, _.length) : _;
      ...
      }(r.url), !0), r.credentials === "include" ? a.withCredentials = !0 : r.credentials === "omit" && (a.withCredentials = !1), "responseType" in a && (ft ? a.responseType = "blob" : yt && r.headers.get("Content-Type") && r.headers.get("Content-Type").indexOf("application/octet-stream") !== -1 && (a.responseType = "arraybuffer")), !e || typeof e.headers != "object" || e.headers instanceof N ? r.headers.forEach(function(n, l) {
  ...
  class Di extends wi {
    ...
    getEyeBlinkParameterId(e) {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        const i = this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(t);
        if (!i.isNull() && !i.isError() && i.getValueByString(Se).getRawString() == Nt) return V.getIdManager().getId(i.getValueByString(xt).getValueByIndex(e).getRawString());
      }
      return null;
    }
    ...
    getLipSyncParameterId(e) {
      ...
      for (let t = 0; t < this._jsonValue.at(w.FrequestNode_Groups).getSize(); t++) {
        const i = this._jsonValue.at(w.FrequestNode_Groups).getValueByIndex(t);
        if (!i.isNull() && !i.isError() && i.getValueByString(Se).getRawString() == Ot) return V.getIdManager().getId(i.getValueByString(xt).getValueByIndex(e).getRawString());
      }
      return null;
    }
    isExistModelFile() {
  ...
  class Ke {
    static create(e, t) {
      const i = new Ke(), r = U.create(e, t), a = r.getRoot();
      ...
      for (let l = 0; l < n; ++l) {
        ...
        let _ = 0;
        for (let g = 0; g < u; ++g) {
          const d = h.getValueByIndex(g), c = new Qe(), m = V.getIdManager().getId(d.getValueByString("Id").getRawString());
          if (c.partId = m, !d.getValueByString(Oi).isNull()) {
            const p = d.getValueByString(Oi), v = p.getSize();
            for (let x = 0; x < v; ++x) {
              const M = new Qe(), f = V.getIdManager().getId(p.getValueByIndex(x).getString());
  ...
  class P {
    ...
    static cardanoAlgorithmForBezier(e, t, i, r) {
      ...
      if (_ < 0) {
        const m = -n / 3, p = m * m * m, v = this.sqrt(p), x = -h / (2 * v), M = this.range(x, -1, 1), f = Math.acos(M), A = 2 * this.cbrt(v), T = A * this.cos(f / 3) - a / 3;
  ...
  class Oe {
    ...
    updateParameters(e, t, i) {
      ...
      let r = this._weight;
      r = r * (this._fadeInSeconds == 0 ? 1 : P.getEasingSine((i - t.getFadeInStartTime()) / this._fadeInSeconds)) * (this._fadeOutSeconds == 0 || t.getEndTime() < 0 ? 1 : P.getEasingSine((t.getEndTime() - i) / this._fadeOutSeconds)), t.setState(i, r), re(0 <= r && r <= 1), this.doUpdateParameters(e, i, r, t), t.getEndTime() > 0 && t.getEndTime() < i && t.setIsFinished(!0);
    }
    setFadeInTime(e) {
  ...
  class Ct extends Oe {
    ...
    parse(e, t) {
      const i = U.create(e, t), r = i.getRoot();
  ...
  function mr(s, e) {
    ...
    t < 0 && (t = 0);
    const i = Q(s[0], s[1], t), r = Q(s[1], s[2], t), a = Q(s[2], s[3], t), o = Q(i, r, t), n = Q(r, a, t);
    return Q(o, n, t).value;
  }
  function pr(s, e) {
    const t = e, i = s[0].time, r = s[3].time, a = s[1].time, o = s[2].time, n = r - 3 * o + 3 * a - i, l = 3 * o - 6 * a + 3 * i, h = 3 * a - 3 * i, u = i - t, _ = P.cardanoAlgorithmForBezier(n, l, h, u), g = Q(s[0], s[1], _), d = Q(s[1], s[2], _), c = Q(s[2], s[3], _), m = Q(g, d, _), p = Q(d, c, _);
  ...
  class Pt extends Oe {
    ...
    isExistModelOpacity() {
      for (let e = 0; e < this._motionData.curveCount; e++) {
        ...
        if (t.type == W.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Mt) == 0) return !0;
      }
      return !1;
    }
    getModelOpacityIndex() {
    ...
    getModelOpacityId(e) {
      if (e != -1) {
        const t = this._motionData.curves.at(e);
        if (t.type == W.CubismMotionCurveTarget_Model && t.id.getString().s.localeCompare(Mt) == 0) return V.getIdManager().getId(t.id.getString().s);
      }
      return null;
    }
    getModelOpacityValue() {
    ...
    stabilization(e) {
      ...
      for (let M = 0; M < this._physicsRig.subRigCount; ++M) {
        ...
        for (let f = 0; f < _.outputCount; ++f) {
          ...
          if (d[f].destinationParameterIndex == -1 && (d[f].destinationParameterIndex = e.getParameterIndex(d[f].destination.id)), A < 1 || A >= _.particleCount) continue;
          let T = new B();
      ...
      for (f = this._physicsRig.fps > 0 ? 1 / this._physicsRig.fps : t; this._currentRemainTime >= f; ) {
        ...
        for (let E = 0; E < this._physicsRig.subRigCount; ++E) {
          ...
          for (let I = 0; I < g.outputCount; ++I) {
            ...
            if (c[I].destinationParameterIndex == -1 && (c[I].destinationParameterIndex = e.getParameterIndex(c[I].destination.id)), z < 1 || z >= g.particleCount) continue;
            const Ye = new B();
            ...
            const ut = c[I].destinationParameterIndex, tr = !Float32Array.prototype.slice && "subarray" in Float32Array.prototype ? JSON.parse(JSON.stringify(this._parameterCaches.subarray(ut))) : this._parameterCaches.slice(ut);
  ...
  class Ue {
    ...
    setupShaderProgram(e, t, i, r, a, o, n, l, h, u, _, g, d, c, m) {
      ...
      if (d || X("NoPremultipliedAlpha is not allowed"), this._shaderSets.getSize() == 0 && this.generateShaders(), e.getClippingContextBufferForMask() != null) {
        ...
        const A = e.getClippingContextBufferForMask()._layoutChannelNo, T = e.getClippingContextBufferForMask().getClippingManager().getChannelFlagAsColor(A);
        ...
        const f = e.getClippingContextBufferForDraw() != null, A = f ? m ? 2 : 1 : 0;
        let T = new $t();
        switch (h) {
        ...
        if (this.gl.useProgram(T.shaderProgram), n.vertex == null && (n.vertex = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ARRAY_BUFFER, n.vertex), this.gl.bufferData(this.gl.ARRAY_BUFFER, r, this.gl.DYNAMIC_DRAW), this.gl.enableVertexAttribArray(T.attributePositionLocation), this.gl.vertexAttribPointer(T.attributePositionLocation, 2, this.gl.FLOAT, !1, 0, 0), n.uv == null && (n.uv = this.gl.createBuffer()), this.gl.bindBuffer(this.gl.ARRAY_BUFFER, n.uv), this.gl.bufferData(this.gl.ARRAY_BUFFER, o, this.gl.DYNAMIC_DRAW), this.gl.enableVertexAttribArray(T.attributeTexCoordLocation), this.gl.vertexAttribPointer(T.attributeTexCoordLocation, 2, this.gl.FLOAT, !1, 0, 0), f) {
          ...
          const I = e.getClippingContextBufferForDraw()._layoutChannelNo, z = e.getClippingContextBufferForDraw().getClippingManager().getChannelFlagAsColor(I);
    ...
    loadShaderProgram(e, t) {
      ...
      if (!r) return X("Vertex shader compile error!"), 0;
...
Please call 'CubimRenderer_WebGL.startUp' function.`);
  ...
  class Us {
    ...
    setPartOpacityByIndex(e, t) {
      this._notExistPartOpacities.isExist(e) ? this._notExistPartOpacities.setValue(e, t) : (re(0 <= e && e < this.getPartCount()), this._partOpacities[e] = t);
    }
    ...
    getPartOpacityByIndex(e) {
      return this._notExistPartOpacities.isExist(e) ? this._notExistPartOpacities.getValue(e) : (re(0 <= e && e < this.getPartCount()), this._partOpacities[e]);
    }
    ...
    getParameterValueByIndex(e) {
      return this._notExistParameterValues.isExist(e) ? this._notExistParameterValues.getValue(e) : (re(0 <= e && e < this.getParameterCount()), this._parameterValues[e]);
    }
    ...
    getDrawableMultiplyColor(e) {
      const t = this._model.drawables.multiplyColors, i = 4 * e, r = new H();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
    getDrawableScreenColor(e) {
      const t = this._model.drawables.screenColors, i = 4 * e, r = new H();
      return r.R = t[i], r.G = t[i + 1], r.B = t[i + 2], r.A = t[i + 3], r;
    }
    ...
    initialize() {
      ...
      }
      {
        ...
        const r = new Or(!1, !1);
        for (let a = 0; a < e; ++a) {
          const o = new H(1, 1, 1, 1), n = new H(0, 0, 0, 1), l = new Ns(!1, o), h = new Ns(!1, n);
        ...
        for (let a = 0; a < i; ++a) {
          const o = new H(1, 1, 1, 1), n = new H(0, 0, 0, 1), l = new Os(!1, o), h = new Os(!1, n);
  ...
  class rt {
    static create(e, t) {
      let i = null;
      if (t && !this.hasMocConsistency(e)) return X("Inconsistent MOC3."), i;
  ...
  class Et {
    ...
    isHit(e, t, i) {
      ...
      for (let d = 1; d < a; ++d) {
        const c = o[fe.vertexOffset + d * fe.vertexStep], m = o[fe.vertexOffset + d * fe.vertexStep + 1];
  ...
  class jr extends Et {
    loadAssets(e, t) {
      return Js(this, void 0, void 0, function* () {
        ...
        const i = yield ee(t), r = yield i.arrayBuffer(), a = new Di(r, r.byteLength);
    ...
    startMotion(e, t, i, r) {
      ...
      else if (!this._motionManager.reserveMotion(i)) return this._debugMode && Y.printMessage("[APP]can't start motion."), wt;
      const a = this._modelSetting.getMotionFileName(e, t), o = `${e}_${t}`;
      let n = this._motions.getValue(o), l = !1;
      n == null ? ee(`${this._modelHomeDir}${a}`).then((u) => u.arrayBuffer()).then((u) => {
    ...
    startRandomMotion(e, t, i) {
      if (this._modelSetting.getMotionCount(e) == 0) return wt;
    ...
    hasMocConsistencyFromFile() {
      return Js(this, void 0, void 0, function* () {
        if (re(this._modelSetting.getModelFileName().localeCompare("")), this._modelSetting.getModelFileName() != "") {
          const e = this._modelSetting.getModelFileName(), t = yield ee(`${this._modelHomeDir}${e}`), i = yield t.arrayBuffer();
...
`;
  ...
  const ei = 35, _e = "#00A6ED", Wr = "white", Rt = "rgb(224, 209, 41)";
  let te, je, ti = !1, Zs = 35;
  ...
  class ie {
    ...
    onUpdate() {
      ...
      for (let r = 0; r < i; ++r) {
        const a = new O(), o = this.getModel(r);
  ...
  class Jr {
    ...
    createTextureFromFile(e, t, i) {
      return r = this, a = void 0, n = function* () {
        ...
        const h = e.split(".").at(-1).toLowerCase(), u = yield ee(e), _ = yield u.arrayBuffer(), g = new Blob([_], { type: "image/" + h }), d = URL.createObjectURL(g);
        l.src = d;
  ...
  let R = null, Ve = null, y = null, si = null;
  class k {
    static getInstance() {
  ...
  function ia(s) {
    if (k.getInstance()._captured = !1, !k.getInstance()._view) return;
  ...
  function ra(s) {
    if (!k.getInstance()._captured || !k.getInstance()._view) return;
